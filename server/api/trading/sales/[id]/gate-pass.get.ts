...
/**
 * GET /api/trading/sales/:id/gate-pass — printable gate-pass data + the
 * HMAC-signed verify URL ('CTDELIV|' namespace, distinct from credit
 * sales' 'DELIV|'). No amounts — driver-facing.
 */
