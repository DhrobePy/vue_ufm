...
export default defineEventHandler(async (event) => {
  ...
  `, [employee_id, basicSalary, houseAllow, transportAllow, medicalAllow,
      otherAllows, provFund, taxDed, otherDeds, grossSalary, netSalary])

  // Keep base_salary in hr_employees in sync
