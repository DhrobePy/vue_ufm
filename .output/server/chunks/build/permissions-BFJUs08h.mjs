...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-6" }, _attrs))} data-v-ccc1255c>`);
      _push(ssrRenderComponent(_component_UiPageHeader, {
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="btn-ghost text-xs" data-v-ccc1255c${_scopeId}>\u2190 Back</button><button class="btn-gold text-xs"${ssrIncludeBooleanAttr(unref(saving) || unref(changesCount) === 0) ? " disabled" : ""} data-v-ccc1255c${_scopeId}>`);
            if (unref(saving)) {
              _push2(`<svg class="w-3.5 h-3.5 animate-spin" fill="none" viewBox="0 0 24 24" data-v-ccc1255c${_scopeId}><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-ccc1255c${_scopeId}></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z" data-v-ccc1255c${_scopeId}></path></svg>`);
            } else {
              _push2(`<!---->`);
            }
      ...
      _push(`<div class="glass-card p-4 flex items-center gap-4" data-v-ccc1255c><div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold text-black shrink-0" style="${ssrRenderStyle({ "background": "linear-gradient(135deg,var(--accent-from),var(--accent-to))", "color": "var(--accent-text)" })}" data-v-ccc1255c>${ssrInterpolate((_a2 = unref(user).name[0]) != null ? _a2 : "?")}</div><div class="flex-1 min-w-0" data-v-ccc1255c><p class="text-sm font-semibold text-gray-200" data-v-ccc1255c>${ssrInterpolate(unref(user).name)}</p><p class="text-xs text-gray-500" data-v-ccc1255c>${ssrInterpolate(unref(user).email)} \xB7 Role: <span class="font-mono text-[11px]" style="${ssrRenderStyle({ "color": "var(--accent-from)" })}" data-v-ccc1255c>${ssrInterpolate(unref(user).role)}</span></p></div><div class="text-xs text-gray-600 text-right" data-v-ccc1255c><p data-v-ccc1255c>Last Login</p><p class="text-gray-400" data-v-ccc1255c>${ssrInterpolate(unref(user).lastLogin ? new Date(unref(user).lastLogin).toLocaleDateString() : "\u2014")}</p></div></div>`);
      if (unref(loadError)) {
        _push(`<div class="glass-card p-4 border border-red-500/30 text-red-400 text-sm" data-v-ccc1255c> \u26A0\uFE0F ${ssrInterpolate(unref(loadError))}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="glass-card p-5" data-v-ccc1255c><h2 class="section-title mb-1" data-v-ccc1255c>Global Data Scope</h2><p class="text-xs text-gray-500 mb-4" data-v-ccc1255c>Controls which records this user can see across all modules.</p><div class="flex flex-wrap gap-5" data-v-ccc1255c><!--[-->`);
      ssrRenderList(scopes, (s) => {
        _push(`<label class="flex items-center gap-2.5 cursor-pointer group" data-v-ccc1255c><div class="${ssrRenderClass([
        ...
        if (unref(globalScope) === s.value) {
          _push(`<div class="w-2 h-2 rounded-full bg-amber-400" data-v-ccc1255c></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div data-v-ccc1255c><p class="text-sm font-medium text-gray-300" data-v-ccc1255c>${ssrInterpolate(s.label)}</p><p class="text-[11px] text-gray-600" data-v-ccc1255c>${ssrInterpolate(s.desc)}</p></div></label>`);
      });
      _push(`<!--]--></div>`);
      if (unref(globalScope) === "branch") {
        _push(`<div class="mt-4 flex flex-wrap gap-3" data-v-ccc1255c><!--[-->`);
        ssrRenderList(branches, (b) => {
          _push(`<label class="flex items-center gap-2 cursor-pointer" data-v-ccc1255c><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(allowedBranches)) ? ssrLooseContain(unref(allowedBranches), b.value) : unref(allowedBranches)) ? " checked" : ""}${ssrRenderAttr("value", b.value)} class="w-4 h-4 rounded border-white/20 bg-white/5 accent-amber-500" data-v-ccc1255c><span class="text-sm text-gray-300" data-v-ccc1255c>${ssrInterpolate(b.label)}</span></label>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="flex items-center gap-3 px-1" data-v-ccc1255c><button class="btn-ghost text-xs" data-v-ccc1255c>Enable All Modules</button><button class="btn-ghost text-xs" data-v-ccc1255c>Disable All</button><button class="btn-ghost text-xs" data-v-ccc1255c>Expand All</button><button class="btn-ghost text-xs" data-v-ccc1255c>Collapse All</button><span class="flex-1" data-v-ccc1255c></span><span class="text-xs text-gray-600" data-v-ccc1255c>${ssrInterpolate(unref(enabledCount))} / ${ssrInterpolate(moduleRegistry.length)} modules enabled </span></div><div class="space-y-2" data-v-ccc1255c><!--[-->`);
      ssrRenderList(moduleRegistry, (mod) => {
        var _a3, _b2, _c2, _d2, _e2, _f2, _g2, _h2, _i2, _j2;
        _push(`<div class="${ssrRenderClass([((_a3 = unref(perms)[mod.key]) == null ? void 0 : _a3.enabled) ? "" : "opacity-60", "glass-card overflow-hidden transition-opacity"])}" data-v-ccc1255c><div class="${ssrRenderClass([unref(expanded)[mod.key] && ((_b2 = unref(perms)[mod.key]) == null ? void 0 : _b2.enabled) ? "border-b border-white/[0.05]" : "", "flex items-center gap-3 p-4 cursor-pointer select-none"])}" data-v-ccc1255c><div class="${ssrRenderClass([
        ...
        ])}" data-v-ccc1255c>${ssrInterpolate(mod.icon)}</div><div class="flex-1 min-w-0" data-v-ccc1255c><p class="text-sm font-semibold text-gray-200" data-v-ccc1255c>${ssrInterpolate(mod.label)}</p><p class="text-xs text-gray-600" data-v-ccc1255c>${ssrInterpolate(mod.pages.length)} pages \xB7 ${ssrInterpolate(countActions(mod))} actions</p></div>`);
        if ((_d2 = unref(perms)[mod.key]) == null ? void 0 : _d2.enabled) {
          _push(`<div class="text-[11px] text-gray-600 shrink-0 mr-2 hidden sm:block" data-v-ccc1255c>${ssrInterpolate((_g2 = (_f2 = (_e2 = unref(perms)[mod.key]) == null ? void 0 : _e2.pages) == null ? void 0 : _f2.length) != null ? _g2 : 0)}/${ssrInterpolate(mod.pages.length)} pages </div>`);
        } else {
          _push(`<!---->`);
        }
        ...
        ])}" data-v-ccc1255c><span class="${ssrRenderClass([
        ...
        ])}" data-v-ccc1255c></span></button><svg class="${ssrRenderClass([unref(expanded)[mod.key] ? "rotate-180" : "", "w-4 h-4 text-gray-600 transition-transform duration-200 shrink-0"])}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-ccc1255c><path d="m6 9 6 6 6-6" data-v-ccc1255c></path></svg></div>`);
        if (unref(expanded)[mod.key] && ((_j2 = unref(perms)[mod.key]) == null ? void 0 : _j2.enabled)) {
          _push(`<div class="divide-y divide-white/[0.04]" data-v-ccc1255c><div class="px-4 py-2 flex items-center gap-3 bg-white/[0.02]" data-v-ccc1255c><input type="checkbox"${ssrRenderAttr("id", `mod-all-${mod.key}`)}${ssrIncludeBooleanAttr(allPagesEnabled(mod)) ? " checked" : ""}${ssrRenderAttr("indeterminate", somePagesEnabled(mod) && !allPagesEnabled(mod))} class="w-4 h-4 rounded border-white/20 bg-white/5 accent-amber-500" data-v-ccc1255c><label${ssrRenderAttr("for", `mod-all-${mod.key}`)} class="text-xs text-gray-500 cursor-pointer select-none" data-v-ccc1255c> Select all pages &amp; actions </label></div><!--[-->`);
          ssrRenderList(mod.pages, (pg) => {
            var _a4, _b3;
            _push(`<div class="p-4" data-v-ccc1255c><div class="flex items-center gap-3 mb-2" data-v-ccc1255c><input type="checkbox"${ssrRenderAttr("id", `pg-${mod.key}-${pg.key}`)}${ssrIncludeBooleanAttr(isPageAllowed(mod.key, pg.key)) ? " checked" : ""} class="w-4 h-4 rounded border-white/20 bg-white/5 accent-amber-500 shrink-0" data-v-ccc1255c><label${ssrRenderAttr("for", `pg-${mod.key}-${pg.key}`)} class="text-sm font-medium text-gray-300 cursor-pointer select-none flex-1" data-v-ccc1255c>${ssrInterpolate(pg.label)}</label><span class="text-[10px] font-mono text-gray-700 shrink-0" data-v-ccc1255c>/${ssrInterpolate(pg.route)}</span></div>`);
            if (((_a4 = pg.actions) == null ? void 0 : _a4.length) && isPageAllowed(mod.key, pg.key)) {
              _push(`<div class="ml-7 flex flex-wrap gap-x-4 gap-y-1.5" data-v-ccc1255c><!--[-->`);
              ssrRenderList(pg.actions, (act) => {
                _push(`<label class="flex items-center gap-1.5 cursor-pointer group" data-v-ccc1255c><input type="checkbox"${ssrIncludeBooleanAttr(isActionAllowed(mod.key, pg.key, act.key)) ? " checked" : ""} class="w-3.5 h-3.5 rounded border-white/20 bg-white/5 accent-amber-500 shrink-0" data-v-ccc1255c><span class="${ssrRenderClass([
                ...
                ])}" data-v-ccc1255c>${ssrInterpolate(act.label)}</span></label>`);
              });
              _push(`<!--]--></div>`);
            } else if (((_b3 = pg.actions) == null ? void 0 : _b3.length) && !isPageAllowed(mod.key, pg.key)) {
              _push(`<div class="ml-7 text-[11px] text-gray-700 italic" data-v-ccc1255c> Enable page to configure actions </div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
      ...
      _push(`<!--]--></div><div class="sticky bottom-4 flex justify-end pt-2" data-v-ccc1255c><div class="glass-card px-4 py-3 flex items-center gap-3 shadow-xl" data-v-ccc1255c>`);
      if (unref(saveSuccess)) {
        _push(`<span class="text-xs text-green-400 font-medium" data-v-ccc1255c>\u2713 Saved successfully</span>`);
      } else if (unref(saveError)) {
        _push(`<span class="text-xs text-red-400 max-w-xs truncate" data-v-ccc1255c>\u26A0 ${ssrInterpolate(unref(saveError))}</span>`);
      } else {
        _push(`<span class="${ssrRenderClass([unref(changesCount) ? "text-amber-400" : "text-gray-500", "text-xs"])}" data-v-ccc1255c>${ssrInterpolate(unref(changesCount) ? "Unsaved changes" : "No unsaved changes")}</span>`);
      }
      _push(`<button class="btn-ghost text-xs"${ssrIncludeBooleanAttr(unref(saving) || !unref(changesCount)) ? " disabled" : ""} data-v-ccc1255c>Reset</button><button class="btn-gold text-xs"${ssrIncludeBooleanAttr(unref(saving) || !unref(changesCount)) ? " disabled" : ""} data-v-ccc1255c>`);
      if (unref(saving)) {
        _push(`<svg class="w-3.5 h-3.5 animate-spin mr-1 inline" fill="none" viewBox="0 0 24 24" data-v-ccc1255c><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-ccc1255c></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z" data-v-ccc1255c></path></svg>`);
      } else {
        _push(`<!---->`);
      }
...
const permissions = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ccc1255c"]]);

export { permissions as default };
//# sourceMappingURL=permissions-BFJUs08h.mjs.map
