...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrInterpolate, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 space-y-5" }, _attrs))}><div><h1 class="text-2xl font-bold text-white">Salary Structure</h1><p class="text-sm text-gray-400 mt-0.5">Manage per-employee compensation breakdown</p></div><div class="grid grid-cols-12 gap-5"><div class="col-span-12 lg:col-span-4"><div class="card overflow-hidden"><div class="px-4 py-3 border-b border-white/[0.06]"><input${ssrRenderAttr("value", unref(search))} placeholder="Search\u2026" class="input-field w-full text-sm"></div><div class="overflow-y-auto max-h-[600px]"><!--[-->`);
...
//# sourceMappingURL=salary-structure-Cy4PJ_ic.mjs.map
