...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 space-y-5" }, _attrs))}><div class="flex items-center justify-between flex-wrap gap-3"><div><h1 class="text-2xl font-bold text-white">Salary Advances</h1><p class="text-sm text-gray-400">${ssrInterpolate(unref(advances).length)} records</p></div><button class="btn-primary flex items-center gap-2"><span>+</span> New Advance </button></div><div class="flex gap-2"><!--[-->`);
...
//# sourceMappingURL=advances-DpJzYGp6.mjs.map
