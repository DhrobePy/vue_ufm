...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderTeleport, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1 class="text-2xl font-bold text-white">Bonus Management</h1><p class="text-sm text-gray-400">Festival &amp; performance bonuses</p></div></div><button class="btn-primary">+ New Batch</button></div><div class="card overflow-hidden"><div class="overflow-x-auto"><table class="w-full text-sm"><thead><tr class="border-b border-white/[0.06]"><th class="th">Batch Name</th><th class="th">Type</th><th class="th">Method</th><th class="th text-right">Total Amount</th><th class="th">Disburse Date</th><th class="th text-center">Status</th><th class="th text-right">Actions</th></tr></thead><tbody><!--[-->`);
...
//# sourceMappingURL=bonuses-CPkg31fR.mjs.map
