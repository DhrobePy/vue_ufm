        ...
        if ((unref(form).advancePaid || 0) > 0) {
          ...
          if (unref(form).advanceMethod === "Cash") {
            ...
            ssrRenderList(unref(pettyCashAccounts), (a) => {
              _push(`<option${ssrRenderAttr("value", a.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).advanceCashAccountId) ? ssrLooseContain(unref(form).advanceCashAccountId, a.id) : ssrLooseEqual(unref(form).advanceCashAccountId, a.id)) ? " selected" : ""}>${ssrInterpolate(a.account_name)} (${ssrInterpolate(a.branch_name || "Head Office")}) </option>`);
            });
            _push(`<!--]--></select></div>`);
          } else {
            _push(`<!---->`);
...
//# sourceMappingURL=create-D-k6UiEk.mjs.map
