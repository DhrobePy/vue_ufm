    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        ssrRenderList(unref(grns), (grn) => {
          ...
          if (grn.quality_grade) {
            _push(`<span> \xB7 Grade ${ssrInterpolate(grn.quality_grade)}</span>`);
          } else {
            _push(`<!---->`);
          }
        ...
        if (unref(payments).length) {
          ...
          ssrRenderList(unref(payments), (pmt) => {
            var _a, _b;
            _push(`<div class="flex items-center justify-between p-3 rounded-xl bg-white/[0.03] border border-white/[0.07] text-xs"><div><p class="font-semibold text-gray-200">\u09F3${ssrInterpolate(Number((_b = (_a = pmt.amount_paid) != null ? _a : pmt.amount) != null ? _b : 0).toLocaleString())}</p><p class="text-gray-500 mt-0.5">${ssrInterpolate(pmt.payment_date)} \xB7 ${ssrInterpolate(pmt.payment_mode || pmt.payment_method || "\u2014")} `);
            if (pmt.bank_name) {
...
//# sourceMappingURL=index-DG4NVkxO.mjs.map
