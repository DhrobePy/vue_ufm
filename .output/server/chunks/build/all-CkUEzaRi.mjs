...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</label><button class="btn-ghost text-xs py-1.5">Reset</button><a${ssrRenderAttr("href", unref(detailExportUrl))} class="btn-ghost text-xs py-1.5" title="One row per line item, with truck/delivery info and approval/dispatch/delivery timestamps">\u2B07 Detailed CSV</a><div class="ml-auto flex items-center gap-3 text-xs text-gray-500"><span class="font-medium text-gray-300">${ssrInterpolate((_b = (_a = unref(data)) == null ? void 0 : _a.total) != null ? _b : 0)}</span> orders </div></div>`);
      if (unref(pending)) {
...
//# sourceMappingURL=all-CkUEzaRi.mjs.map
