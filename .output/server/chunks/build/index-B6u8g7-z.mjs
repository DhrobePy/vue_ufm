    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`\u{1F4CA} Variance Report`);
                } else {
                  return [
      ...
      if (unref(pending)) {
        ...
        _push(ssrRenderComponent(_component_UiDataTable, {
          ...
          "cell-grn_number": withCtx(({ row }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_NuxtLink, {
                to: `/purchase/grn/${row.id}`,
                class: "font-mono text-xs text-gold-400/80 font-medium hover:underline"
              }, {
                default: withCtx((_, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(row.grn_number)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(row.grn_number), 1)
                    ];
                  }
                }),
                _: 2
...
//# sourceMappingURL=index-B6u8g7-z.mjs.map
