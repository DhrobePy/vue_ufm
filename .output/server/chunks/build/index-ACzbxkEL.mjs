...
import { defineComponent, reactive, ref, withAsyncContext, computed, mergeProps, withCtx, createTextVNode, createVNode, unref, toDisplayString, useSSRContext } from 'vue';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(pending) && !unref(error)) {
        ...
        ssrRenderList(unref(rows), (g) => {
          ...
          _push(`</td><td class="px-3 py-3 text-gray-400 whitespace-nowrap">${ssrInterpolate(g.grn_date)}</td><td class="px-3 py-3">`);
          _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          if (g.grn_status !== "cancelled") {
            _push(`<button class="text-red-500 hover:text-red-400 text-xs" title="Delete">\u{1F5D1}</button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></td></tr>`);
...
//# sourceMappingURL=index-ACzbxkEL.mjs.map
