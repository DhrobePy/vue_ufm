...
import { defineComponent, computed, ref, withAsyncContext, mergeProps, withCtx, createTextVNode, createVNode, unref, openBlock, createBlock, createCommentVNode, toDisplayString, useSSRContext } from 'vue';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(ssrRenderComponent(_component_UiDataTable, {
          ...
          "search-placeholder": "",
          onRowClick: (row) => {
            if (unref(isSuperadmin)) ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))(`/admin/users/${row.id}/permissions`);
          }
        }, {
          ...
          actions: withCtx(({ row }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                unref(isSuperadmin) ? (openBlock(), createBlock(_component_NuxtLink, {
                  key: 0,
                  to: `/admin/users/${row.id}/permissions`,
                  class: "btn-ghost text-[11px] py-1 px-2.5"
                }, {
...
//# sourceMappingURL=index-DLXHC1nV.mjs.map
