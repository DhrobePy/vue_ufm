...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderTeleport, ssrRenderAttr, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 space-y-5" }, _attrs))}><div class="flex items-center justify-between flex-wrap gap-3"><div><h1 class="text-2xl font-bold text-white">Company Holidays</h1><p class="text-sm text-gray-400">${ssrInterpolate(unref(holidays).length)} holidays</p></div><button class="btn-primary flex items-center gap-2"><span>+</span> Add Holiday </button></div><div class="card overflow-hidden"><div class="overflow-x-auto"><table class="w-full text-sm"><thead><tr class="border-b border-white/[0.06]"><th class="th">Date</th><th class="th">Holiday Name</th><th class="th">Description</th><th class="th text-right">Action</th></tr></thead><tbody><!--[-->`);
...
//# sourceMappingURL=holidays-UpdpY_TR.mjs.map
