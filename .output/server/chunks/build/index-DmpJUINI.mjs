...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="glass-card p-5"><h2 class="section-title mb-4">Quick Links</h2><div class="flex flex-wrap gap-3">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/purchase/orders",
...
//# sourceMappingURL=index-DmpJUINI.mjs.map
