...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const qrDataUrl = ref("");
    const dispatchPin = computed(() => {
      var _a, _b, _c;
      return (_c = (_b = (_a = data.value) == null ? void 0 : _a.order) == null ? void 0 : _b.dispatch_pin) != null ? _c : null;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div style="${ssrRenderStyle({ "margin-top": "28px", "background": "#faf8f5", "border-top": "1px solid #f0ede8", "padding": "16px 40px", "display": "flex", "align-items": "center", "justify-content": "space-between" })}"><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#9ca3af" })}"> Generated by Ujjal FMC ERP \xB7 ${ssrInterpolate(unref(generatedAt))}</div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#9ca3af", "text-align": "center" })}"> This is a computer-generated invoice and is valid without signature<br> when processed through the ERP system. </div><div style="${ssrRenderStyle({ "text-align": "right" })}">`);
      if (unref(qrDataUrl)) {
        _push(`<img${ssrRenderAttr("src", unref(qrDataUrl))} style="${ssrRenderStyle({ "width": "72px", "height": "72px", "border-radius": "6px", "border": "1px solid #e5e7eb", "display": "block", "margin-left": "auto" })}">`);
      } else {
        _push(`<div style="${ssrRenderStyle({ "width": "72px", "height": "72px", "background": "#f3f4f6", "border": "1px solid #e5e7eb", "border-radius": "6px", "margin-left": "auto" })}"></div>`);
      }
      if (unref(dispatchPin)) {
        _push(`<div style="${ssrRenderStyle({ "margin-top": "4px", "font-family": "monospace", "font-size": "12px", "font-weight": "800", "color": "#111827", "letter-spacing": "3px", "text-align": "center" })}">${ssrInterpolate(unref(dispatchPin))}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div style="${ssrRenderStyle({ "font-size": "8px", "color": "#9ca3af", "margin-top": "2px", "text-align": "center" })}">Scan \xB7 PIN to confirm dispatch</div></div></div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=invoice-Dp9MoFpy.mjs.map
