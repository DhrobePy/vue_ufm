...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><header class="h-16 shrink-0 flex items-center gap-4 px-6 relative z-30" style="${ssrRenderStyle(`background: var(--topbar-bg); backdrop-filter: blur(16px); border-bottom: 1px solid rgb(var(--tint)/0.07);`)}" data-v-4d7dc9ae><button class="w-9 h-9 rounded-xl flex items-center justify-center text-gray-500 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150 shrink-0" data-v-4d7dc9ae><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-4d7dc9ae><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h7" data-v-4d7dc9ae></path></svg></button><div class="hidden sm:flex items-center gap-1.5 text-sm min-w-0" data-v-4d7dc9ae><span class="text-gray-600 truncate" data-v-4d7dc9ae>${ssrInterpolate(unref(currentModule))}</span>`);
      if (unref(currentPage)) {
        _push(`<span class="text-gray-700" data-v-4d7dc9ae>/</span>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(currentPage)) {
        _push(`<span class="text-gray-300 font-medium truncate" data-v-4d7dc9ae>${ssrInterpolate(unref(currentPage))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="flex-1" data-v-4d7dc9ae></div><button class="hidden md:flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm text-gray-500 transition-all duration-150 hover:text-gray-300 hover:bg-white/[0.05] shrink-0" style="${ssrRenderStyle({ "border": "1px solid rgba(255,255,255,0.07)", "min-width": "200px" })}" data-v-4d7dc9ae><svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-4d7dc9ae><circle cx="11" cy="11" r="8" data-v-4d7dc9ae></circle><path d="m21 21-4.35-4.35" data-v-4d7dc9ae></path></svg><span class="flex-1 text-left text-xs" data-v-4d7dc9ae>Quick search\u2026</span><kbd class="text-[10px] font-mono text-gray-600 bg-white/[0.05] px-1.5 py-0.5 rounded border border-white/[0.08]" data-v-4d7dc9ae>\u2318K</kbd></button><button class="w-9 h-9 rounded-xl flex items-center justify-center text-gray-500 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150 shrink-0" title="Appearance settings" data-v-4d7dc9ae><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" data-v-4d7dc9ae><path stroke-linecap="round" stroke-linejoin="round" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.1 0 2-.9 2-2v-.5c0-.28-.11-.53-.29-.71-.18-.18-.29-.43-.29-.71 0-.55.45-1 1-1h1.17c2.76 0 5.12-1.93 5.12-5C21 6.48 17.04 2 12 2z" data-v-4d7dc9ae></path><circle cx="7" cy="11.5" r="1.5" fill="currentColor" stroke="none" data-v-4d7dc9ae></circle><circle cx="10" cy="8" r="1.5" fill="currentColor" stroke="none" data-v-4d7dc9ae></circle><circle cx="14" cy="8" r="1.5" fill="currentColor" stroke="none" data-v-4d7dc9ae></circle><circle cx="17" cy="11.5" r="1.5" fill="currentColor" stroke="none" data-v-4d7dc9ae></circle></svg></button><div class="relative" data-v-4d7dc9ae><button class="relative w-9 h-9 rounded-xl flex items-center justify-center text-gray-500 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150" data-v-4d7dc9ae><svg class="${ssrRenderClass([
        "w-4 h-4 transition-colors duration-300",
        unref(bellRing) ? "animate-bell text-gold-400" : unref(unreadCount) > 0 ? "text-gold-400/70" : ""
      ])}" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" data-v-4d7dc9ae><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" data-v-4d7dc9ae></path></svg>`);
      if (unref(unreadCount) > 0) {
        ...
        ])}" style="${ssrRenderStyle(`background: linear-gradient(135deg, var(--accent-from), var(--accent-to)); color: var(--accent-text)`)}" data-v-4d7dc9ae>${ssrInterpolate(unref(unreadCount) > 9 ? "9+" : unref(unreadCount))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</button>`);
      if (unref(notifOpen)) {
        _push(`<div class="absolute right-0 top-full mt-2 w-84 rounded-2xl overflow-hidden z-50" style="${ssrRenderStyle({ "background": "rgba(22,22,22,0.97)", "backdrop-filter": "blur(20px)", "border": "1px solid rgba(255,255,255,0.08)", "box-shadow": "0 16px 48px rgba(0,0,0,0.6)", "width": "340px" })}" data-v-4d7dc9ae><div class="flex items-center justify-between px-4 py-3 border-b border-white/[0.06]" data-v-4d7dc9ae><p class="text-sm font-semibold text-gray-200" data-v-4d7dc9ae>Notifications</p><div class="flex items-center gap-2" data-v-4d7dc9ae>`);
        if (unref(unreadCount) > 0) {
          _push(`<span class="badge text-[10px] px-2 py-0.5 rounded-full font-bold" style="${ssrRenderStyle(`background:linear-gradient(135deg,var(--accent-from),var(--accent-to));color:var(--accent-text)`)}" data-v-4d7dc9ae>${ssrInterpolate(unref(unreadCount))} new </span>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(unreadCount) > 0) {
          _push(`<button class="text-[10px] text-gray-500 hover:text-gray-300 transition-colors" data-v-4d7dc9ae> Mark all read </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div class="divide-y divide-white/[0.04] max-h-72 overflow-y-auto" data-v-4d7dc9ae><!--[-->`);
        ssrRenderList(unref(unreadNotifications), (n) => {
          _push(`<div class="flex gap-3 px-4 py-3 cursor-pointer transition-colors group hover:bg-white/[0.04]" data-v-4d7dc9ae><div class="${ssrRenderClass([n.type === "warning" ? "bg-yellow-400" : n.type === "error" ? "bg-red-400" : n.type === "info" ? "bg-blue-400" : "bg-emerald-400", "w-2 h-2 rounded-full mt-1.5 shrink-0 transition-transform group-hover:scale-125"])}" data-v-4d7dc9ae></div><div class="flex-1 min-w-0" data-v-4d7dc9ae><p class="text-xs text-gray-300 leading-snug" data-v-4d7dc9ae>${ssrInterpolate(n.text)}</p><p class="text-[10px] text-gray-600 mt-0.5" data-v-4d7dc9ae>${ssrInterpolate(n.time)}</p></div><div class="w-1.5 h-1.5 rounded-full mt-1.5 shrink-0" style="${ssrRenderStyle({ "background": "var(--accent-from)" })}" data-v-4d7dc9ae></div><svg class="w-3 h-3 text-gray-700 mt-1.5 shrink-0 group-hover:text-gray-400 transition-colors" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-4d7dc9ae><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" data-v-4d7dc9ae></path></svg></div>`);
        });
        _push(`<!--]-->`);
        if (!unref(unreadNotifications).length) {
          _push(`<div class="px-4 py-8 text-center text-xs text-gray-600" data-v-4d7dc9ae> All caught up \u{1F389} </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="px-4 py-2.5 border-t border-white/[0.06] flex justify-between items-center" data-v-4d7dc9ae>`);
        ...
        if (unref(unreadNotifications).length) {
          _push(`<button class="text-[10px] text-gray-600 hover:text-gray-400" data-v-4d7dc9ae>Clear all</button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      ...
      _push(`</div><div class="hidden lg:flex flex-col items-end shrink-0" data-v-4d7dc9ae><span class="text-xs font-medium text-gray-300" data-v-4d7dc9ae>${ssrInterpolate(unref(formattedDate))}</span><span class="text-[11px] text-gray-600" data-v-4d7dc9ae>${ssrInterpolate(unref(formattedTime))}</span></div><div class="relative" data-v-4d7dc9ae><button class="flex items-center gap-2.5 pl-1 pr-2 py-1 rounded-xl hover:bg-white/[0.07] transition-all duration-150 shrink-0" data-v-4d7dc9ae><div class="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold shrink-0" style="${ssrRenderStyle(`background: linear-gradient(135deg, var(--accent-from), var(--accent-to)); color: var(--accent-text)`)}" data-v-4d7dc9ae>${ssrInterpolate(unref(userInitials))}</div><div class="hidden md:flex flex-col items-start" data-v-4d7dc9ae><span class="text-xs font-semibold text-gray-200 leading-tight" data-v-4d7dc9ae>${ssrInterpolate(((_a = unref(sessionUser)) == null ? void 0 : _a.name) || "User")}</span><span class="text-[10px] text-gray-500 leading-tight font-mono" data-v-4d7dc9ae>${ssrInterpolate(((_b = unref(sessionUser)) == null ? void 0 : _b.role) || "")}</span></div><svg class="w-3 h-3 text-gray-600 ml-0.5 hidden md:block" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-4d7dc9ae><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" data-v-4d7dc9ae></path></svg></button>`);
      if (unref(dropdownOpen)) {
        _push(`<div class="absolute right-0 top-full mt-2 w-56 rounded-2xl overflow-hidden z-50" style="${ssrRenderStyle({ "background": "rgba(22,22,22,0.97)", "backdrop-filter": "blur(20px)", "border": "1px solid rgba(255,255,255,0.08)", "box-shadow": "0 16px 48px rgba(0,0,0,0.6)" })}" data-v-4d7dc9ae><div class="p-3 border-b border-white/[0.06]" data-v-4d7dc9ae><p class="text-sm font-semibold text-gray-100" data-v-4d7dc9ae>${ssrInterpolate((_c = unref(sessionUser)) == null ? void 0 : _c.name)}</p><p class="text-xs text-gray-500 mt-0.5" data-v-4d7dc9ae>${ssrInterpolate((_d = unref(sessionUser)) == null ? void 0 : _d.email)}</p><p class="text-[10px] font-mono text-gold-500/80 mt-0.5" data-v-4d7dc9ae>${ssrInterpolate((_e = unref(sessionUser)) == null ? void 0 : _e.role)}</p></div><div class="p-1.5 space-y-0.5" data-v-4d7dc9ae>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/admin/settings",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-4d7dc9ae${_scopeId}><circle cx="12" cy="12" r="3" data-v-4d7dc9ae${_scopeId}></circle><path d="M19.07 4.93l-1.41 1.41M4.93 19.07l1.41-1.41M12 2v2M12 20v2M2 12h2M20 12h2" data-v-4d7dc9ae${_scopeId}></path></svg> Settings `);
            } else {
              return [
        ...
        _push(`<button class="flex items-center gap-2.5 w-full px-3 py-2 rounded-lg text-sm text-gray-400 hover:text-gray-100 hover:bg-white/[0.06] transition-all duration-150" data-v-4d7dc9ae><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" data-v-4d7dc9ae><path stroke-linecap="round" stroke-linejoin="round" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.1 0 2-.9 2-2v-.5c0-.28-.11-.53-.29-.71-.18-.18-.29-.43-.29-.71 0-.55.45-1 1-1h1.17c2.76 0 5.12-1.93 5.12-5C21 6.48 17.04 2 12 2z" data-v-4d7dc9ae></path><circle cx="7" cy="11.5" r="1.5" fill="currentColor" stroke="none" data-v-4d7dc9ae></circle><circle cx="10" cy="8" r="1.5" fill="currentColor" stroke="none" data-v-4d7dc9ae></circle><circle cx="14" cy="8" r="1.5" fill="currentColor" stroke="none" data-v-4d7dc9ae></circle><circle cx="17" cy="11.5" r="1.5" fill="currentColor" stroke="none" data-v-4d7dc9ae></circle></svg> Appearance </button><button class="flex items-center gap-2.5 w-full px-3 py-2 rounded-lg text-sm text-gray-400 hover:text-gray-100 hover:bg-white/[0.06] transition-all duration-150" data-v-4d7dc9ae><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-4d7dc9ae><circle cx="11" cy="11" r="8" data-v-4d7dc9ae></circle><path d="m21 21-4.35-4.35" data-v-4d7dc9ae></path></svg> Search <kbd class="ml-auto text-[10px] font-mono text-gray-600" data-v-4d7dc9ae>\u2318K</kbd></button></div><div class="p-1.5 border-t border-white/[0.06]" data-v-4d7dc9ae><button class="flex items-center gap-2.5 w-full px-3 py-2 rounded-lg text-sm text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-all duration-150" data-v-4d7dc9ae><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-4d7dc9ae><path d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h6a2 2 0 012 2v1" data-v-4d7dc9ae></path></svg> Sign out </button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></header>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4d7dc9ae"]]);
...
//# sourceMappingURL=default-PegoEUV7.mjs.map
