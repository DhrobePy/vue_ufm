...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(source) === "gl") {
        _push(`<div class="text-xs text-blue-400/70 px-1 -mt-2"> \u{1F4D2} Showing all journal-entry lines posted to this account&#39;s GL ledger \u2014 includes expense payments, customer advance receipts, transfers, and manual entries. </div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(pending)) {
...
//# sourceMappingURL=statement-5jTlxWGy.mjs.map
