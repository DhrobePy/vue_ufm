...
import { defineComponent, withAsyncContext, computed, ref, mergeProps, unref, withCtx, openBlock, createBlock, toDisplayString, createCommentVNode, createVNode, useSSRContext } from 'vue';
          ...
          actions: withCtx(({ row }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                ...
                }, toDisplayString(unref(acting) === row.id ? "\u2026" : "Dispatch"), 9, ["onClick", "disabled"])) : createCommentVNode("", true)
              ];
            }
          }),
          _: 1
...
//# sourceMappingURL=dispatch-BZGGQhgk.mjs.map
