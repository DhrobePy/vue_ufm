...
import { defineComponent, withAsyncContext, computed, ref, reactive, unref, mergeProps, withCtx, createVNode, toDisplayString, useSSRContext } from 'vue';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/fleet/trips/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-DfSeQzNA.mjs.map
