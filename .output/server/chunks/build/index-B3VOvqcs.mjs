...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 space-y-6" }, _attrs))}><div class="flex items-center justify-between flex-wrap gap-3"><div><h1 class="text-2xl font-bold text-white">HR Dashboard</h1><p class="text-sm text-gray-400 mt-0.5">${ssrInterpolate(unref(todayLabel))}</p></div><div class="flex gap-2">`);
...
//# sourceMappingURL=index-B3VOvqcs.mjs.map
