...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-f657e899><div class="absolute top-0 left-0 right-0 h-[2px]" style="${ssrRenderStyle({ "background": "linear-gradient(90deg, transparent, var(--accent-from), transparent)" })}" data-v-f657e899></div><div class="absolute top-0 left-0 w-full h-64 pointer-events-none" style="${ssrRenderStyle({ "background": "radial-gradient(ellipse at top left, rgba(var(--accent-glow),0.06) 0%, transparent 70%)" })}" data-v-f657e899></div><div class="${ssrRenderClass([__props.collapsed ? "justify-center" : "justify-between", "relative flex items-center h-16 px-4 shrink-0"])}" data-v-f657e899><div class="flex items-center gap-3 overflow-hidden" data-v-f657e899><div class="shrink-0 w-9 h-9 rounded-xl flex items-center justify-center animate-glow-pulse" style="${ssrRenderStyle(`background: linear-gradient(135deg, var(--accent-from), var(--accent-to)); box-shadow: 0 0 16px rgba(var(--accent-glow),0.4)`)}" data-v-f657e899><span class="font-display font-bold text-base leading-none" style="${ssrRenderStyle(`color: var(--accent-text)`)}" data-v-f657e899>U</span></div>`);
      if (!__props.collapsed) {
        _push(`<div class="flex flex-col" data-v-f657e899><span class="font-display font-bold text-sm text-white leading-tight tracking-tight" data-v-f657e899>Ujjal FMC</span><span class="text-[10px] font-medium uppercase tracking-widest leading-tight" style="${ssrRenderStyle(`color: var(--accent-from); opacity: 0.8`)}" data-v-f657e899>ERP System</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (!__props.collapsed) {
        _push(`<button class="w-7 h-7 rounded-lg flex items-center justify-center text-gray-500 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150 shrink-0" data-v-f657e899><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-f657e899><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" data-v-f657e899></path></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="mx-4 h-px bg-white/[0.06]" data-v-f657e899></div><nav class="flex-1 overflow-y-auto no-scrollbar py-3 px-2 space-y-0.5" data-v-f657e899>`);
      ...
      _push(`<div class="py-1" data-v-f657e899>`);
      if (!__props.collapsed) {
        _push(`<div class="px-3 mb-1" data-v-f657e899><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-f657e899>Operations</span></div>`);
      } else {
        _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-f657e899></div>`);
      }
      _push(`</div>`);
      ...
      _push(`<div class="py-1" data-v-f657e899>`);
      if (!__props.collapsed) {
        _push(`<div class="px-3 mb-1" data-v-f657e899><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-f657e899>Finance</span></div>`);
      } else {
        _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-f657e899></div>`);
      }
      _push(`</div>`);
      ...
      _push(`<div class="py-1" data-v-f657e899>`);
      if (!__props.collapsed) {
        _push(`<div class="px-3 mb-1" data-v-f657e899><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-f657e899>Standalone Modules</span></div>`);
      } else {
        _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-f657e899></div>`);
      }
      _push(`</div>`);
      ...
      _push(`<div class="py-1" data-v-f657e899>`);
      if (!__props.collapsed) {
        _push(`<div class="px-3 mb-1" data-v-f657e899><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-f657e899>More</span></div>`);
      } else {
        _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-f657e899></div>`);
      }
      _push(`</div>`);
      ...
      _push(`<div class="py-1" data-v-f657e899>`);
      if (!__props.collapsed) {
        _push(`<div class="px-3 mb-1" data-v-f657e899><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-f657e899>Human Resources</span></div>`);
      } else {
        _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-f657e899></div>`);
      }
      _push(`</div>`);
      ...
      _push(`</nav><div class="shrink-0 mx-2 mb-3" data-v-f657e899><div class="h-px bg-white/[0.06] mb-3" data-v-f657e899></div><div class="${ssrRenderClass([
      ...
      ])}" data-v-f657e899><div class="shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold" style="${ssrRenderStyle(`background: linear-gradient(135deg, var(--accent-from), var(--accent-to)); color: var(--accent-text)`)}" data-v-f657e899>${ssrInterpolate(unref(initials))}</div>`);
      if (!__props.collapsed) {
        _push(`<div class="flex-1 min-w-0" data-v-f657e899><p class="text-sm font-medium text-gray-200 truncate leading-tight" data-v-f657e899>${ssrInterpolate(((_a = unref(sessionUser)) == null ? void 0 : _a.name) || "User")}</p><p class="text-[11px] text-gray-500 truncate leading-tight font-mono" data-v-f657e899>${ssrInterpolate(((_b = unref(sessionUser)) == null ? void 0 : _b.role) || "")}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!__props.collapsed) {
        _push(`<button class="w-7 h-7 rounded-lg flex items-center justify-center text-gray-600 hover:text-red-400 hover:bg-red-500/10 transition-all duration-150 shrink-0" data-v-f657e899><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-f657e899><path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h6a2 2 0 012 2v1" data-v-f657e899></path></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (__props.collapsed) {
        _push(`<button class="mt-1 w-full h-8 rounded-xl flex items-center justify-center text-gray-600 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150" data-v-f657e899><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-f657e899><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" data-v-f657e899></path></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></aside>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-f657e899"]]);
const BASE_THEMES = [
  {
    id: "midnight",
    name: "Midnight",
...
//# sourceMappingURL=default-BzaHmmxR.mjs.map
