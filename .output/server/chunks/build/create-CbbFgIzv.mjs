...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const [{ data: custData }, { data: prodData }, { data: bankData }, { data: pettyData }, { data: empData }] = ([__temp, __restore] = withAsyncContext(() => Promise.all([
      useFetch(
        "/api/customers",
        { query: { per: 200 } },
        "$RqEScBQ_sV"
      ...
      if (unref(currentStep) === 2) {
        ...
        if ((unref(form).advancePaid || 0) > 0) {
          ...
          if (unref(form).advanceMethod === "Cash") {
            _push(`<div class="md:col-span-2 space-y-1.5"><label class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Petty Cash Account *</label><select class="input-glass"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).advanceCashAccountId) ? ssrLooseContain(unref(form).advanceCashAccountId, "") : ssrLooseEqual(unref(form).advanceCashAccountId, "")) ? " selected" : ""}>\u2014 Select account \u2014</option><!--[-->`);
            ssrRenderList(unref(pettyCashAccounts), (a) => {
              _push(`<option${ssrRenderAttr("value", a.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).advanceCashAccountId) ? ssrLooseContain(unref(form).advanceCashAccountId, a.id) : ssrLooseEqual(unref(form).advanceCashAccountId, a.id)) ? " selected" : ""}>${ssrInterpolate(a.account_name)} (Balance: \u09F3${ssrInterpolate(Number(a.current_balance).toLocaleString())}) </option>`);
            });
            _push(`<!--]--></select></div>`);
          } else {
            _push(`<!---->`);
          ...
          if (["Bank Transfer", "Cheque", "Card"].includes(unref(form).advanceMethod)) {
            _push(`<!--[--><div class="space-y-1.5"><label class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Bank Account *</label><select class="input-glass"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).advanceBankAccountId) ? ssrLooseContain(unref(form).advanceBankAccountId, "") : ssrLooseEqual(unref(form).advanceBankAccountId, "")) ? " selected" : ""}>\u2014 Select account \u2014</option><!--[-->`);
            ssrRenderList(unref(bankAccounts), (a) => {
              _push(`<option${ssrRenderAttr("value", a.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).advanceBankAccountId) ? ssrLooseContain(unref(form).advanceBankAccountId, a.id) : ssrLooseEqual(unref(form).advanceBankAccountId, a.id)) ? " selected" : ""}>${ssrInterpolate(a.bank_name)} \u2013 ${ssrInterpolate(a.account_name)}</option>`);
            });
            _push(`<!--]--></select></div>`);
          ...
          _push(`<div class="space-y-1.5"><label class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Collected By</label><select class="input-glass"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).advanceCollectedBy) ? ssrLooseContain(unref(form).advanceCollectedBy, "") : ssrLooseEqual(unref(form).advanceCollectedBy, "")) ? " selected" : ""}>\u2014 Select employee \u2014</option><!--[-->`);
          ssrRenderList(unref(employees), (e) => {
            _push(`<option${ssrRenderAttr("value", e.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).advanceCollectedBy) ? ssrLooseContain(unref(form).advanceCollectedBy, e.id) : ssrLooseEqual(unref(form).advanceCollectedBy, e.id)) ? " selected" : ""}>${ssrInterpolate(e.first_name)} ${ssrInterpolate(e.last_name)}</option>`);
          });
...
//# sourceMappingURL=create-CbbFgIzv.mjs.map
