...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrRenderTeleport } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1 class="text-2xl font-bold text-white">Employees</h1><p class="text-sm text-gray-400 mt-0.5">${ssrInterpolate(unref(filtered).length)} of ${ssrInterpolate(unref(employees).length)} shown</p></div></div><button class="btn-primary flex items-center gap-2"><span class="text-lg leading-none">+</span> Add Employee </button></div><div class="flex flex-wrap gap-3"><input${ssrRenderAttr("value", unref(search))} placeholder="Search name / email\u2026" class="input-field w-56 text-sm"><select class="input-field text-sm"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(filterDept)) ? ssrLooseContain(unref(filterDept), "") : ssrLooseEqual(unref(filterDept), "")) ? " selected" : ""}>All Departments</option><!--[-->`);
...
//# sourceMappingURL=index-BwOEc1Rk.mjs.map
