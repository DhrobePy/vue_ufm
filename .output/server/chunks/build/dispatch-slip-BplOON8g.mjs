  ...
  async setup(__props) {
    ...
    const { data, pending, error } = ([__temp, __restore] = withAsyncContext(() => useFetch(
      `/api/credit-sales/${route.params.id}/dispatch-slip`,
      {
        query: computed(() => {
          var _a;
          return { delivery_id: (_a = deliveryId.value) != null ? _a : void 0 };
        })
      },
      "$I9tbdplYAU"
      /* nuxt-injected */
    ...
    const delivery = computed(() => {
      var _a;
      return (_a = data.value) == null ? void 0 : _a.delivery;
    });
...
//# sourceMappingURL=dispatch-slip-BplOON8g.mjs.map
