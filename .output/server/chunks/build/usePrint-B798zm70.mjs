function usePrint() {
  function printElement(elementId, title = "Ujjal FMC ERP") {
    const el = (void 0).getElementById(elementId);
    if (!el) return;
    const w = (void 0).open("", "_blank", "width=900,height=700");
    if (!w) return;
    Array.from((void 0).styleSheets).map((s) => {
      try {
...
<script>window.onload = () => { window.print(); window.close(); }<\/script>
  ...
  return { printElement, printPage };
}

export { usePrint as u };
//# sourceMappingURL=usePrint-B798zm70.mjs.map
