...
import { defineComponent, ref, reactive, withAsyncContext, computed, watch, mergeProps, unref, withCtx, createTextVNode, useSSRContext } from 'vue';
      ...
      if (unref(currentStep) === 0) {
        ...
        if (unref(form).customerId && unref(selectedCustomer)) {
          ...
          if (unref(creditUtilPct) > 100) {
            _push(`<p class="text-[11px] text-red-400/90 leading-snug"> \u26A0 This order will take ${ssrInterpolate(unref(selectedCustomer).name)} over their credit limit. The order will be escalated for CFO approval. </p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
...
//# sourceMappingURL=create-D6icUSoM.mjs.map
