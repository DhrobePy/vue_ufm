...
import { defineComponent, withAsyncContext, computed, mergeProps, withCtx, createVNode, unref, toDisplayString, useSSRContext } from 'vue';
      ...
      _push(ssrRenderComponent(_component_UiPageHeader, {
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createVNode("button", { class: "btn-gold text-xs" }, "Export PDF")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=ageing-DoPGIjhR.mjs.map
