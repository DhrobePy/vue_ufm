...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div style="${ssrRenderStyle({ "font-size": "8px", "color": "#9ca3af", "margin-top": "4px", "text-align": "center" })}">Scan for gate pass &amp; delivery</div></div></div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=invoice--2PzooHd.mjs.map
