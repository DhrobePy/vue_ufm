...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div>\u2022 Goods must conform to specified quality standards upon delivery.</div><div>\u2022 Moisture content must not exceed 13% for wheat.</div><div>\u2022 Supplier must provide phytosanitary certificate for imported wheat.</div><div>\u2022 Payment terms: ${ssrInterpolate(unref(po).paymentTermsLabel)} from GRN acceptance.</div><div>\u2022 Any short delivery must be notified before unloading.</div><div>\u2022 Subject to Sirajgonj jurisdiction.</div></div></div><div style="${ssrRenderStyle({ "background": "#faf8f5", "border-radius": "12px", "padding": "18px", "border": "1px solid #f0ede8", "align-self": "start" })}"><!--[-->`);
...
//# sourceMappingURL=print-CaU4nZYQ.mjs.map
