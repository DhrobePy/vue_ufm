...
import { defineComponent, ref, computed, withAsyncContext, mergeProps, unref, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, createVNode, useSSRContext } from 'vue';
      ...
      if (unref(pending)) {
        ...
        _push(ssrRenderComponent(_component_UiDataTable, {
          ...
          "cell-date": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="text-gray-300 text-xs whitespace-nowrap"${_scopeId}>${ssrInterpolate(fmtDate(value))}</span>`);
            } else {
              return [
              ...
              if (linkFor(row)) {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${ssrInterpolate(linkFor(row).label)} <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"${_scopeId2}></path></svg>`);
                    } else {
                      return [
...
//# sourceMappingURL=ledger-vlonQzWX.mjs.map
