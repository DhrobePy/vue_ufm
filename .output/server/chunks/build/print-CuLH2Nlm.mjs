...
import { k as useRoute, e as createError, p as useUserSession } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const commodityName = computed(() => {
      var _a2;
      return (_a2 = rawPo.commodity_name) != null ? _a2 : "Wheat";
    });
    const printUnit = computed(() => isMt.value ? "MT" : rawPo.commodity_unit);
    const po = computed(() => {
      var _a2, _b2, _c2, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p;
      const qtyDisplay = isMt.value ? Number(rawPo.quantity_kg || 0) / 1e3 : Number(rawPo.quantity_kg || 0);
      const priceDisplay = isMt.value ? Number(rawPo.unit_price_per_kg || 0) * 1e3 : Number(rawPo.unit_price_per_kg || 0);
      const rawTermsStr = String((_c2 = (_b2 = (_a2 = rawPo.po_payment_terms) != null ? _a2 : rawPo.supplier_payment_terms) != null ? _b2 : rawPo.payment_terms) != null ? _c2 : "");
      ...
      return {
        poNo: (_d = rawPo.po_number) != null ? _d : `PO-${id}`,
        ...
        rawExpectedDelivery: rawPo.expected_delivery_date,
        // keep raw for due-date calc
        deliveryTo: (_m = (_l = rawPo.branch_name) != null ? _l : rawPo.unload_point_name) != null ? _m : "Sirajgonj Mill",
        paymentTerms,
        paymentTermsLabel,
        origin: (_n = rawPo.wheat_origin) != null ? _n : "\u2014",
        notes: (_o = rawPo.remarks) != null ? _o : "",
        ...
        grns: rawGrns.map((g) => ({
          ...
          qty: isMt.value ? +(Number(g.quantity_received_kg || 0) / 1e3).toFixed(2) : Number(g.quantity_received_kg || 0),
        ...
        payments: rawPayments.map((p) => {
          ...
          return {
            ...
            payType: (_c3 = p.payment_type) != null ? _c3 : "",
            bank: (_d2 = p.bank_name) != null ? _d2 : "",
            ref: (_e2 = p.reference_number) != null ? _e2 : ""
          };
        }),
        ...
        paymentStatus: (_p = rawPo.payment_status) != null ? _p : "unpaid"
      };
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(po).grns.length > 0) {
        _push(`<div style="${ssrRenderStyle({ "margin": "0 40px", "padding": "18px 20px", "background": "#f0fdf4", "border-radius": "10px", "border": "1px solid #bbf7d0", "margin-bottom": "20px" })}"><div style="${ssrRenderStyle({ "font-size": "9px", "font-weight": "800", "color": "#166534", "letter-spacing": "0.12em", "text-transform": "uppercase", "margin-bottom": "12px" })}">Delivery Progress</div><div style="${ssrRenderStyle({ "display": "flex", "gap": "32px", "margin-bottom": "12px" })}"><div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#6b7280" })}">Ordered</div><div style="${ssrRenderStyle({ "font-size": "16px", "font-weight": "800", "color": "#111", "font-family": "monospace" })}">${ssrInterpolate(unref(totalOrdered))} ${ssrInterpolate(unref(printUnit))}</div></div><div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#6b7280" })}">Received</div><div style="${ssrRenderStyle({ "font-size": "16px", "font-weight": "800", "color": "#16a34a", "font-family": "monospace" })}">${ssrInterpolate(unref(totalReceived))} ${ssrInterpolate(unref(printUnit))}</div></div><div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#6b7280" })}">Pending</div><div style="${ssrRenderStyle({ "font-size": "16px", "font-weight": "800", "color": "#ca8a04", "font-family": "monospace" })}">${ssrInterpolate(unref(totalOrdered) - unref(totalReceived))} ${ssrInterpolate(unref(printUnit))}</div></div><div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#6b7280" })}">Completion</div><div style="${ssrRenderStyle({ "font-size": "16px", "font-weight": "800", "color": "#374151", "font-family": "monospace" })}">${ssrInterpolate(Math.round(unref(totalReceived) / unref(totalOrdered) * 100))}%</div></div></div><div style="${ssrRenderStyle({ "height": "6px", "background": "#dcfce7", "border-radius": "9999px", "overflow": "hidden" })}"><div style="${ssrRenderStyle(`width:${Math.round(unref(totalReceived) / unref(totalOrdered) * 100)}%;height:100%;background:#16a34a;border-radius:9999px;`)}"></div></div><table style="${ssrRenderStyle({ "width": "100%", "border-collapse": "collapse", "margin-top": "12px" })}"><thead><tr style="${ssrRenderStyle({ "border-bottom": "1px solid #bbf7d0" })}"><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "left", "font-size": "9px", "color": "#166534", "font-weight": "700", "text-transform": "uppercase" })}">GRN No.</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "left", "font-size": "9px", "color": "#166534", "font-weight": "700", "text-transform": "uppercase" })}">Date</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "right", "font-size": "9px", "color": "#166534", "font-weight": "700", "text-transform": "uppercase" })}">Qty (${ssrInterpolate(unref(printUnit))})</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "center", "font-size": "9px", "color": "#166534", "font-weight": "700", "text-transform": "uppercase" })}">Grade</th></tr></thead><tbody><!--[-->`);
      ...
      if (unref(po).payments.length > 0) {
        _push(`<table style="${ssrRenderStyle({ "width": "100%", "border-collapse": "collapse" })}"><thead><tr style="${ssrRenderStyle({ "border-bottom": "1px solid #bfdbfe" })}"><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "left", "font-size": "9px", "color": "#1e40af", "font-weight": "700", "text-transform": "uppercase" })}">Voucher</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "left", "font-size": "9px", "color": "#1e40af", "font-weight": "700", "text-transform": "uppercase" })}">Date</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "left", "font-size": "9px", "color": "#1e40af", "font-weight": "700", "text-transform": "uppercase" })}">Type</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "left", "font-size": "9px", "color": "#1e40af", "font-weight": "700", "text-transform": "uppercase" })}">Method / Ref</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "right", "font-size": "9px", "color": "#1e40af", "font-weight": "700", "text-transform": "uppercase" })}">Amount (\u09F3)</th></tr></thead><tbody><!--[-->`);
        ssrRenderList(unref(po).payments, (pmt) => {
          _push(`<tr style="${ssrRenderStyle({ "border-bottom": "1px solid #dbeafe" })}"><td style="${ssrRenderStyle({ "padding": "5px 8px", "font-size": "11px", "font-family": "monospace", "color": "#111", "font-weight": "600" })}">${ssrInterpolate(pmt.voucherNo)}</td><td style="${ssrRenderStyle({ "padding": "5px 8px", "font-size": "11px", "color": "#374151" })}">${ssrInterpolate(pmt.date)}</td><td style="${ssrRenderStyle({ "padding": "5px 8px", "font-size": "11px", "color": "#374151", "text-transform": "capitalize" })}">${ssrInterpolate(pmt.payType === "advance" ? "Advance" : pmt.payType === "against_delivery" ? "Against Delivery" : pmt.payType === "contra" ? "Contra" : "Credit")}</td><td style="${ssrRenderStyle({ "padding": "5px 8px", "font-size": "11px", "color": "#374151" })}"><span style="${ssrRenderStyle({ "text-transform": "capitalize" })}">${ssrInterpolate(pmt.method === "contra" ? "Contra Adj." : pmt.method)}</span>`);
          if (pmt.bank) {
          ...
          if (pmt.ref) {
            _push(`<span style="${ssrRenderStyle({ "color": "#6b7280" })}"> \xB7 ${ssrInterpolate(pmt.ref)}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</td><td style="${ssrRenderStyle({ "padding": "5px 8px", "font-size": "11px", "text-align": "right", "font-family": "monospace", "color": "#16a34a", "font-weight": "700" })}"> \u09F3${ssrInterpolate(pmt.amount.toLocaleString())}</td></tr>`);
        });
        _push(`<!--]--></tbody>`);
...
//# sourceMappingURL=print-CuLH2Nlm.mjs.map
