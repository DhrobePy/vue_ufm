...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1 class="text-2xl font-bold text-white">Payroll</h1><p class="text-sm text-gray-400">Prepare \xB7 Approve \xB7 Disburse</p></div></div><div class="flex gap-2">`);
...
//# sourceMappingURL=index-B3IORQ3E.mjs.map
