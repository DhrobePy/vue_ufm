...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-b20711c2><div class="absolute top-0 left-0 right-0 h-[2px]" style="${ssrRenderStyle({ "background": "linear-gradient(90deg, transparent, var(--accent-from), transparent)" })}" data-v-b20711c2></div><div class="absolute top-0 left-0 w-full h-64 pointer-events-none" style="${ssrRenderStyle({ "background": "radial-gradient(ellipse at top left, rgba(var(--accent-glow),0.06) 0%, transparent 70%)" })}" data-v-b20711c2></div><div class="${ssrRenderClass([__props.collapsed ? "justify-center" : "justify-between", "relative flex items-center h-16 px-4 shrink-0"])}" data-v-b20711c2><div class="flex items-center gap-3 overflow-hidden" data-v-b20711c2><div class="shrink-0 w-9 h-9 rounded-xl flex items-center justify-center animate-glow-pulse" style="${ssrRenderStyle(`background: linear-gradient(135deg, var(--accent-from), var(--accent-to)); box-shadow: 0 0 16px rgba(var(--accent-glow),0.4)`)}" data-v-b20711c2><span class="font-display font-bold text-base leading-none" style="${ssrRenderStyle(`color: var(--accent-text)`)}" data-v-b20711c2>U</span></div>`);
      if (!__props.collapsed) {
        _push(`<div class="flex flex-col" data-v-b20711c2><span class="font-display font-bold text-sm text-white leading-tight tracking-tight" data-v-b20711c2>Ujjal FMC</span><span class="text-[10px] font-medium uppercase tracking-widest leading-tight" style="${ssrRenderStyle(`color: var(--accent-from); opacity: 0.8`)}" data-v-b20711c2>ERP System</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (!__props.collapsed) {
        _push(`<button class="w-7 h-7 rounded-lg flex items-center justify-center text-gray-500 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150 shrink-0" data-v-b20711c2><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-b20711c2><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" data-v-b20711c2></path></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="mx-4 h-px bg-white/[0.06]" data-v-b20711c2></div><nav class="flex-1 overflow-y-auto no-scrollbar py-3 px-2 space-y-0.5" data-v-b20711c2>`);
      ...
      _push(`<div class="py-1" data-v-b20711c2>`);
      if (!__props.collapsed) {
        _push(`<div class="px-3 mb-1" data-v-b20711c2><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-b20711c2>Operations</span></div>`);
      } else {
        _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-b20711c2></div>`);
      }
      _push(`</div>`);
      ...
      _push(`<div class="py-1" data-v-b20711c2>`);
      if (!__props.collapsed) {
        _push(`<div class="px-3 mb-1" data-v-b20711c2><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-b20711c2>Finance</span></div>`);
      } else {
        _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-b20711c2></div>`);
      }
      _push(`</div>`);
      ...
      _push(`<div class="py-1" data-v-b20711c2>`);
      if (!__props.collapsed) {
        _push(`<div class="px-3 mb-1" data-v-b20711c2><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-b20711c2>Standalone Modules</span></div>`);
      } else {
        _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-b20711c2></div>`);
      }
      _push(`</div>`);
      ...
      _push(`<div class="py-1" data-v-b20711c2>`);
      if (!__props.collapsed) {
        _push(`<div class="px-3 mb-1" data-v-b20711c2><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-b20711c2>More</span></div>`);
      } else {
        _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-b20711c2></div>`);
      }
      _push(`</div>`);
      ...
      _push(`<div class="py-1" data-v-b20711c2>`);
      if (!__props.collapsed) {
        _push(`<div class="px-3 mb-1" data-v-b20711c2><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-b20711c2>Human Resources</span></div>`);
      } else {
        _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-b20711c2></div>`);
      }
      _push(`</div>`);
      ...
      _push(`</nav><div class="shrink-0 mx-2 mb-3" data-v-b20711c2><div class="h-px bg-white/[0.06] mb-3" data-v-b20711c2></div><div class="${ssrRenderClass([
      ...
      ])}" data-v-b20711c2><div class="shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold" style="${ssrRenderStyle(`background: linear-gradient(135deg, var(--accent-from), var(--accent-to)); color: var(--accent-text)`)}" data-v-b20711c2>${ssrInterpolate(unref(initials))}</div>`);
      if (!__props.collapsed) {
        _push(`<div class="flex-1 min-w-0" data-v-b20711c2><p class="text-sm font-medium text-gray-200 truncate leading-tight" data-v-b20711c2>${ssrInterpolate(((_a = unref(sessionUser)) == null ? void 0 : _a.name) || "User")}</p><p class="text-[11px] text-gray-500 truncate leading-tight font-mono" data-v-b20711c2>${ssrInterpolate(((_b = unref(sessionUser)) == null ? void 0 : _b.role) || "")}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!__props.collapsed) {
        _push(`<button class="w-7 h-7 rounded-lg flex items-center justify-center text-gray-600 hover:text-red-400 hover:bg-red-500/10 transition-all duration-150 shrink-0" data-v-b20711c2><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-b20711c2><path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h6a2 2 0 012 2v1" data-v-b20711c2></path></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (__props.collapsed) {
        _push(`<button class="mt-1 w-full h-8 rounded-xl flex items-center justify-center text-gray-600 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150" data-v-b20711c2><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-b20711c2><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" data-v-b20711c2></path></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></aside>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-b20711c2"]]);
const BASE_THEMES = [
  {
    id: "midnight",
    name: "Midnight",
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><header class="h-16 shrink-0 flex items-center gap-4 px-6 relative z-30" style="${ssrRenderStyle(`background: var(--topbar-bg); backdrop-filter: blur(16px); border-bottom: 1px solid rgb(var(--tint)/0.07);`)}" data-v-57d2aee0><button class="w-9 h-9 rounded-xl flex items-center justify-center text-gray-500 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150 shrink-0" data-v-57d2aee0><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-57d2aee0><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h7" data-v-57d2aee0></path></svg></button><div class="hidden sm:flex items-center gap-1.5 text-sm min-w-0" data-v-57d2aee0><span class="text-gray-600 truncate" data-v-57d2aee0>${ssrInterpolate(unref(currentModule))}</span>`);
      if (unref(currentPage)) {
        _push(`<span class="text-gray-700" data-v-57d2aee0>/</span>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(currentPage)) {
        _push(`<span class="text-gray-300 font-medium truncate" data-v-57d2aee0>${ssrInterpolate(unref(currentPage))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="flex-1" data-v-57d2aee0></div><button class="hidden md:flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm text-gray-500 transition-all duration-150 hover:text-gray-300 hover:bg-white/[0.05] shrink-0" style="${ssrRenderStyle({ "border": "1px solid rgba(255,255,255,0.07)", "min-width": "200px" })}" data-v-57d2aee0><svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-57d2aee0><circle cx="11" cy="11" r="8" data-v-57d2aee0></circle><path d="m21 21-4.35-4.35" data-v-57d2aee0></path></svg><span class="flex-1 text-left text-xs" data-v-57d2aee0>Quick search\u2026</span><kbd class="text-[10px] font-mono text-gray-600 bg-white/[0.05] px-1.5 py-0.5 rounded border border-white/[0.08]" data-v-57d2aee0>\u2318K</kbd></button><button class="w-9 h-9 rounded-xl flex items-center justify-center text-gray-500 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150 shrink-0" title="Appearance settings" data-v-57d2aee0><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" data-v-57d2aee0><path stroke-linecap="round" stroke-linejoin="round" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.1 0 2-.9 2-2v-.5c0-.28-.11-.53-.29-.71-.18-.18-.29-.43-.29-.71 0-.55.45-1 1-1h1.17c2.76 0 5.12-1.93 5.12-5C21 6.48 17.04 2 12 2z" data-v-57d2aee0></path><circle cx="7" cy="11.5" r="1.5" fill="currentColor" stroke="none" data-v-57d2aee0></circle><circle cx="10" cy="8" r="1.5" fill="currentColor" stroke="none" data-v-57d2aee0></circle><circle cx="14" cy="8" r="1.5" fill="currentColor" stroke="none" data-v-57d2aee0></circle><circle cx="17" cy="11.5" r="1.5" fill="currentColor" stroke="none" data-v-57d2aee0></circle></svg></button><div class="relative" data-v-57d2aee0><button class="relative w-9 h-9 rounded-xl flex items-center justify-center text-gray-500 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150" data-v-57d2aee0><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" data-v-57d2aee0><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" data-v-57d2aee0></path></svg>`);
      if (unref(unreadCount) > 0) {
        _push(`<span class="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 rounded-full flex items-center justify-center text-[10px] font-bold px-1" style="${ssrRenderStyle(`background: linear-gradient(135deg, var(--accent-from), var(--accent-to)); color: var(--accent-text)`)}" data-v-57d2aee0>${ssrInterpolate(unref(unreadCount) > 9 ? "9+" : unref(unreadCount))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</button>`);
      if (unref(notifOpen)) {
        ...
        }, ssrGetDirectiveProps(_ctx, vClickOutside, () => notifOpen.value = false)))} data-v-57d2aee0><div class="flex items-center justify-between px-4 py-3 border-b border-white/[0.06]" data-v-57d2aee0><p class="text-sm font-semibold text-gray-200" data-v-57d2aee0>Notifications</p><div class="flex items-center gap-2" data-v-57d2aee0>`);
        if (unref(unreadCount) > 0) {
          _push(`<span class="badge text-[10px] px-2 py-0.5 rounded-full font-bold" style="${ssrRenderStyle(`background:linear-gradient(135deg,var(--accent-from),var(--accent-to));color:var(--accent-text)`)}" data-v-57d2aee0>${ssrInterpolate(unref(unreadCount))} new </span>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(unreadCount) > 0) {
          _push(`<button class="text-[10px] text-gray-500 hover:text-gray-300 transition-colors" data-v-57d2aee0> Mark all read </button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div class="divide-y divide-white/[0.04] max-h-72 overflow-y-auto" data-v-57d2aee0><!--[-->`);
        ssrRenderList(unref(notifications), (n) => {
          _push(`<div class="${ssrRenderClass([n.read ? "opacity-60 hover:opacity-80" : "hover:bg-white/[0.04]", "flex gap-3 px-4 py-3 cursor-pointer transition-colors group"])}" data-v-57d2aee0><div class="${ssrRenderClass([n.type === "warning" ? "bg-yellow-400" : n.type === "error" ? "bg-red-400" : n.type === "info" ? "bg-blue-400" : "bg-emerald-400", "w-2 h-2 rounded-full mt-1.5 shrink-0 transition-transform group-hover:scale-125"])}" data-v-57d2aee0></div><div class="flex-1 min-w-0" data-v-57d2aee0><p class="text-xs text-gray-300 leading-snug" data-v-57d2aee0>${ssrInterpolate(n.text)}</p><p class="text-[10px] text-gray-600 mt-0.5" data-v-57d2aee0>${ssrInterpolate(n.time)}</p></div>`);
          if (!n.read) {
            _push(`<div class="w-1.5 h-1.5 rounded-full bg-gold-400 mt-1.5 shrink-0" data-v-57d2aee0></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<svg class="w-3 h-3 text-gray-700 mt-1.5 shrink-0 group-hover:text-gray-400 transition-colors" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-57d2aee0><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" data-v-57d2aee0></path></svg></div>`);
        });
        _push(`<!--]-->`);
        if (!unref(notifications).length) {
          _push(`<div class="px-4 py-8 text-center text-xs text-gray-600" data-v-57d2aee0> No notifications </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="px-4 py-2.5 border-t border-white/[0.06] flex justify-between items-center" data-v-57d2aee0>`);
        ...
        if (unref(notifications).length) {
          _push(`<button class="text-[10px] text-gray-600 hover:text-gray-400" data-v-57d2aee0>Clear</button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      ...
      _push(`</div><div class="hidden lg:flex flex-col items-end shrink-0" data-v-57d2aee0><span class="text-xs font-medium text-gray-300" data-v-57d2aee0>${ssrInterpolate(unref(formattedDate))}</span><span class="text-[11px] text-gray-600" data-v-57d2aee0>${ssrInterpolate(unref(formattedTime))}</span></div><div class="relative" data-v-57d2aee0><button class="flex items-center gap-2.5 pl-1 pr-2 py-1 rounded-xl hover:bg-white/[0.07] transition-all duration-150 shrink-0" data-v-57d2aee0><div class="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold shrink-0" style="${ssrRenderStyle(`background: linear-gradient(135deg, var(--accent-from), var(--accent-to)); color: var(--accent-text)`)}" data-v-57d2aee0>${ssrInterpolate(unref(userInitials))}</div><div class="hidden md:flex flex-col items-start" data-v-57d2aee0><span class="text-xs font-semibold text-gray-200 leading-tight" data-v-57d2aee0>${ssrInterpolate(((_a = unref(sessionUser)) == null ? void 0 : _a.name) || "User")}</span><span class="text-[10px] text-gray-500 leading-tight font-mono" data-v-57d2aee0>${ssrInterpolate(((_b = unref(sessionUser)) == null ? void 0 : _b.role) || "")}</span></div><svg class="w-3 h-3 text-gray-600 ml-0.5 hidden md:block" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-57d2aee0><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" data-v-57d2aee0></path></svg></button>`);
      if (unref(dropdownOpen)) {
        ...
        }, ssrGetDirectiveProps(_ctx, vClickOutside, () => dropdownOpen.value = false)))} data-v-57d2aee0><div class="p-3 border-b border-white/[0.06]" data-v-57d2aee0><p class="text-sm font-semibold text-gray-100" data-v-57d2aee0>${ssrInterpolate((_c = unref(sessionUser)) == null ? void 0 : _c.name)}</p><p class="text-xs text-gray-500 mt-0.5" data-v-57d2aee0>${ssrInterpolate((_d = unref(sessionUser)) == null ? void 0 : _d.email)}</p><p class="text-[10px] font-mono text-gold-500/80 mt-0.5" data-v-57d2aee0>${ssrInterpolate((_e = unref(sessionUser)) == null ? void 0 : _e.role)}</p></div><div class="p-1.5 space-y-0.5" data-v-57d2aee0>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/admin/settings",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-57d2aee0${_scopeId}><circle cx="12" cy="12" r="3" data-v-57d2aee0${_scopeId}></circle><path d="M19.07 4.93l-1.41 1.41M4.93 19.07l1.41-1.41M12 2v2M12 20v2M2 12h2M20 12h2" data-v-57d2aee0${_scopeId}></path></svg> Settings `);
            } else {
              return [
        ...
        _push(`<button class="flex items-center gap-2.5 w-full px-3 py-2 rounded-lg text-sm text-gray-400 hover:text-gray-100 hover:bg-white/[0.06] transition-all duration-150" data-v-57d2aee0><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" data-v-57d2aee0><path stroke-linecap="round" stroke-linejoin="round" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.1 0 2-.9 2-2v-.5c0-.28-.11-.53-.29-.71-.18-.18-.29-.43-.29-.71 0-.55.45-1 1-1h1.17c2.76 0 5.12-1.93 5.12-5C21 6.48 17.04 2 12 2z" data-v-57d2aee0></path><circle cx="7" cy="11.5" r="1.5" fill="currentColor" stroke="none" data-v-57d2aee0></circle><circle cx="10" cy="8" r="1.5" fill="currentColor" stroke="none" data-v-57d2aee0></circle><circle cx="14" cy="8" r="1.5" fill="currentColor" stroke="none" data-v-57d2aee0></circle><circle cx="17" cy="11.5" r="1.5" fill="currentColor" stroke="none" data-v-57d2aee0></circle></svg> Appearance </button><button class="flex items-center gap-2.5 w-full px-3 py-2 rounded-lg text-sm text-gray-400 hover:text-gray-100 hover:bg-white/[0.06] transition-all duration-150" data-v-57d2aee0><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-57d2aee0><circle cx="11" cy="11" r="8" data-v-57d2aee0></circle><path d="m21 21-4.35-4.35" data-v-57d2aee0></path></svg> Search <kbd class="ml-auto text-[10px] font-mono text-gray-600" data-v-57d2aee0>\u2318K</kbd></button></div><div class="p-1.5 border-t border-white/[0.06]" data-v-57d2aee0><button class="flex items-center gap-2.5 w-full px-3 py-2 rounded-lg text-sm text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-all duration-150" data-v-57d2aee0><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-57d2aee0><path d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h6a2 2 0 012 2v1" data-v-57d2aee0></path></svg> Sign out </button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></header>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-57d2aee0"]]);
...
//# sourceMappingURL=default-B1rb9Vk4.mjs.map
