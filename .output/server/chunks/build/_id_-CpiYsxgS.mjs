...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderStyle, ssrRenderAttr, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex items-center justify-center p-4" }, _attrs))}><div class="glass-card p-6 w-full max-w-md space-y-4"><h1 class="text-lg font-bold text-gray-100">Commodity Dispatch Verification</h1>`);
      if (unref(sale)) {
...
//# sourceMappingURL=_id_-CpiYsxgS.mjs.map
