...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderComponent, ssrRenderTeleport } from 'vue/server-renderer';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.modelValue) {
          _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4" data-v-2e51affe><div class="absolute inset-0 bg-black/60 backdrop-blur-sm" data-v-2e51affe></div><div class="relative w-full max-w-sm glass-card p-7 text-center space-y-4 animate-slide-up" data-v-2e51affe><div class="w-14 h-14 rounded-full bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center mx-auto" data-v-2e51affe><svg class="w-7 h-7 text-emerald-400" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-2e51affe><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" data-v-2e51affe></path></svg></div><h3 class="font-display font-bold text-xl text-white" data-v-2e51affe>Sale Complete!</h3><div class="text-sm text-gray-400 space-y-0.5" data-v-2e51affe><p data-v-2e51affe>Receipt <span class="font-mono text-gold-400" data-v-2e51affe>${ssrInterpolate(__props.receiptNo)}</span></p>`);
          if (__props.customerName) {
            _push2(`<p data-v-2e51affe>Customer: <span class="text-gray-300" data-v-2e51affe>${ssrInterpolate(__props.customerName)}</span></p>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<p data-v-2e51affe>Paid now: <span class="text-gray-300" data-v-2e51affe>\u09F3${ssrInterpolate(__props.cashAmount.toLocaleString())} (${ssrInterpolate(__props.paymentMethod)})</span></p>`);
          if (__props.creditAmount > 0) {
            _push2(`<p data-v-2e51affe>On credit: <span class="text-orange-400" data-v-2e51affe>\u09F3${ssrInterpolate(__props.creditAmount.toLocaleString())}</span></p>`);
          } else {
            _push2(`<!---->`);
          }
          if (__props.discount > 0) {
            _push2(`<p data-v-2e51affe>Discount: <span class="text-orange-400" data-v-2e51affe>-\u09F3${ssrInterpolate(__props.discount.toLocaleString())}</span></p>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<p class="text-base font-bold pt-1" data-v-2e51affe>Total: <strong class="text-gold-400" data-v-2e51affe>\u09F3${ssrInterpolate(__props.total.toLocaleString())}</strong></p>`);
          if (__props.exitStatus === "pending_approval") {
            _push2(`<p class="text-red-400 text-xs pt-1" data-v-2e51affe>\u23F3 Exit release needs approval before goods can leave \u2014 see Pending Approvals.</p>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div><div class="flex gap-3" data-v-2e51affe><button class="btn-ghost flex-1 justify-center text-sm" data-v-2e51affe>\u{1F5A8}\uFE0F Print All (3)</button><button class="btn-gold flex-1 justify-center text-sm" data-v-2e51affe>New Sale</button></div></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-2e51affe"]]);
...
//# sourceMappingURL=index-CigOMWyO.mjs.map
