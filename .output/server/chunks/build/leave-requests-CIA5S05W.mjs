...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1 class="text-2xl font-bold text-white">Leave Requests</h1><p class="text-sm text-gray-400">${ssrInterpolate(unref(requests).length)} records</p></div></div><button class="btn-primary flex items-center gap-2"><span>+</span> New Request </button></div><div class="flex gap-2 flex-wrap"><!--[-->`);
...
//# sourceMappingURL=leave-requests-CIA5S05W.mjs.map
