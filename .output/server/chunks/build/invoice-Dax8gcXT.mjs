...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderComponent, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderList, ssrRenderAttr } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const showOutstanding = computed(() => {
      var _a, _b, _c;
      return ((_c = (_b = (_a = settingsData.value) == null ? void 0 : _a.settings) == null ? void 0 : _b.show_invoice_outstanding) != null ? _c : "1") !== "0";
    });
    ...
    const totalBags = computed(() => items.value.reduce((s, i) => s + i.qty, 0));
    const isDelivered = computed(() => {
      var _a, _b;
      return ["delivered", "completed"].includes((_b = (_a = order.value) == null ? void 0 : _a.status) != null ? _b : "");
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(["customer", "office"], (copyType) => {
        ...
        if (copyType === "customer") {
          ...
          _push(`<div style="${ssrRenderStyle({ "padding-right": "32px", "display": "flex", "gap": "16px", "align-items": "flex-start" })}">`);
          if (!unref(isDelivered)) {
            _push(`<!--[-->`);
            if (unref(qrDataUrl)) {
              _push(`<img${ssrRenderAttr("src", unref(qrDataUrl))} style="${ssrRenderStyle({ "width": "64px", "height": "64px", "border-radius": "6px", "border": "1px solid #e5e7eb", "flex-shrink": "0" })}">`);
            } else {
              _push(`<div style="${ssrRenderStyle({ "width": "64px", "height": "64px", "background": "#f3f4f6", "border": "1px solid #e5e7eb", "border-radius": "6px", "flex-shrink": "0" })}"></div>`);
            }
            _push(`<div><div style="${ssrRenderStyle({ "font-size": "9px", "font-weight": "800", "color": "#9ca3af", "letter-spacing": "0.12em", "text-transform": "uppercase", "margin-bottom": "6px" })}">Gate Pass</div><div style="${ssrRenderStyle({ "font-size": "10.5px", "color": "#6b7280", "line-height": "1.6" })}">Scan to record the gate-out and delivery confirmation for this order (spec \xA72.8). Login required for every scan.</div></div><!--]-->`);
          } else {
            _push(`<div><div style="${ssrRenderStyle({ "font-size": "9px", "font-weight": "800", "color": "#9ca3af", "letter-spacing": "0.12em", "text-transform": "uppercase", "margin-bottom": "6px" })}">Gate Pass</div><div style="${ssrRenderStyle({ "font-size": "10.5px", "color": "#16a34a", "font-weight": "600" })}">\u2713 Delivery already confirmed \u2014 see GRN below.</div></div>`);
          }
          _push(`</div>`);
        }
        _push(`<div style="${ssrRenderStyle({ "background": "#faf8f5", "border-radius": "12px", "padding": "14px 20px", "border": "1px solid #f0ede8" })}"><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "space-between", "padding": "3px 0", "font-size": "12px" })}"><span style="${ssrRenderStyle({ "color": "#6b7280" })}">Subtotal</span><span style="${ssrRenderStyle({ "font-family": "monospace", "color": "#374151" })}">\u09F3${ssrInterpolate(unref(subtotal).toLocaleString())}</span></div><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "space-between", "padding": "5px 0", "font-size": "12px" })}"><span style="${ssrRenderStyle({ "color": "#6b7280" })}">Line Discounts</span><span style="${ssrRenderStyle({ "font-family": "monospace", "color": "#dc2626" })}">-\u09F3${ssrInterpolate(unref(totalDiscount).toLocaleString())}</span></div><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "space-between", "padding": "5px 0", "font-size": "12px" })}"><span style="${ssrRenderStyle({ "color": "#6b7280" })}">Overall Discount</span><span style="${ssrRenderStyle({ "font-family": "monospace", "color": "#dc2626" })}">\u09F30</span></div><div style="${ssrRenderStyle({ "border-top": "1px solid #e5e0d8", "margin": "8px 0" })}"></div><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "space-between", "padding": "8px 0", "font-size": "15px", "font-weight": "800" })}"><span style="${ssrRenderStyle({ "color": "#111" })}">Invoice Total</span><span style="${ssrRenderStyle({ "font-family": "monospace", "color": "#b45309" })}">\u09F3${ssrInterpolate(((_f = (_e = unref(order)) == null ? void 0 : _e.total) != null ? _f : 0).toLocaleString())}</span></div><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "space-between", "padding": "5px 0", "font-size": "12px" })}"><span style="${ssrRenderStyle({ "color": "#6b7280" })}">Total Paid${ssrInterpolate(unref(payments).length > 1 ? ` (${unref(payments).length} payments)` : unref(payments).length === 1 ? " (1 payment)" : "")}</span><span style="${ssrRenderStyle({ "font-family": "monospace", "color": "#16a34a", "font-weight": "600" })}">-\u09F3${ssrInterpolate(unref(totalPaid).toLocaleString())}</span></div><div style="${ssrRenderStyle({ "background": "linear-gradient(135deg,#fef3c7,#fef9ee)", "border-radius": "8px", "padding": "12px 14px", "margin-top": "8px", "border": "1px solid #fcd34d" })}"><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "space-between", "font-size": "14px", "font-weight": "800" })}"><span style="${ssrRenderStyle({ "color": "#92400e" })}">Balance Due</span><span style="${ssrRenderStyle({ "font-family": "monospace", "color": "#b45309" })}">\u09F3${ssrInterpolate(((_h = (_g = unref(order)) == null ? void 0 : _g.balanceDue) != null ? _h : 0).toLocaleString())}</span></div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#b45309", "margin-top": "4px", "opacity": "0.8" })}">Due: ${ssrInterpolate((_i = unref(order)) == null ? void 0 : _i.requiredDate)}</div></div></div></div>`);
        if (unref(payments).length && copyType === "customer") {
          _push(`<div style="${ssrRenderStyle({ "margin": "0 40px 14px", "padding": "14px 20px", "border-radius": "12px", "background": "#f9fafb", "border": "1px solid #f0ede8" })}"><div style="${ssrRenderStyle({ "font-size": "9px", "font-weight": "800", "color": "#9ca3af", "letter-spacing": "0.12em", "text-transform": "uppercase", "margin-bottom": "8px" })}"> Payment History </div><table style="${ssrRenderStyle({ "width": "100%", "border-collapse": "collapse" })}"><thead><tr style="${ssrRenderStyle({ "border-bottom": "1px solid #e5e7eb" })}"><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "left", "font-size": "9px", "font-weight": "700", "color": "#9ca3af", "text-transform": "uppercase" })}">Date</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "left", "font-size": "9px", "font-weight": "700", "color": "#9ca3af", "text-transform": "uppercase" })}">Reference</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "left", "font-size": "9px", "font-weight": "700", "color": "#9ca3af", "text-transform": "uppercase" })}">Method</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "left", "font-size": "9px", "font-weight": "700", "color": "#9ca3af", "text-transform": "uppercase" })}">Note</th><th style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "right", "font-size": "9px", "font-weight": "700", "color": "#9ca3af", "text-transform": "uppercase" })}">Amount</th></tr></thead><tbody><!--[-->`);
          ssrRenderList(unref(payments), (p) => {
            _push(`<tr style="${ssrRenderStyle({ "border-bottom": "1px solid #f3f4f6" })}"><td style="${ssrRenderStyle({ "padding": "4px 8px", "font-size": "11px", "color": "#374151", "font-family": "monospace" })}">${ssrInterpolate(String(p.payment_date).slice(0, 10))}</td><td style="${ssrRenderStyle({ "padding": "4px 8px", "font-size": "11px", "color": "#374151", "font-family": "monospace" })}">${ssrInterpolate(p.payment_number)}</td><td style="${ssrRenderStyle({ "padding": "4px 8px", "font-size": "11px", "color": "#6b7280" })}">${ssrInterpolate(p.payment_method)}</td><td style="${ssrRenderStyle({ "padding": "4px 8px", "font-size": "10px", "color": "#9ca3af", "font-style": "italic" })}">${ssrInterpolate(p.notes || "\u2014")}</td><td style="${ssrRenderStyle({ "padding": "4px 8px", "text-align": "right", "font-size": "12px", "font-weight": "700", "color": "#16a34a", "font-family": "monospace" })}">\u09F3${ssrInterpolate(Number(p.amount).toLocaleString())}</td></tr>`);
          });
          _push(`<!--]--></tbody><tfoot><tr style="${ssrRenderStyle({ "border-top": "2px solid #e5e7eb" })}"><td colspan="4" style="${ssrRenderStyle({ "padding": "5px 8px", "font-size": "12px", "font-weight": "700", "color": "#374151" })}">Total Paid</td><td style="${ssrRenderStyle({ "padding": "5px 8px", "text-align": "right", "font-size": "13px", "font-weight": "800", "color": "#16a34a", "font-family": "monospace" })}">\u09F3${ssrInterpolate(unref(totalPaid).toLocaleString())}</td></tr></tfoot></table></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div style="${ssrRenderStyle({ "margin": "0 40px", "padding": "10px 0 0", "border-top": "1px solid #f0ede8", "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "32px" })}"><div style="${ssrRenderStyle({ "text-align": "center" })}"><div style="${ssrRenderStyle({ "height": "32px", "border-bottom": "1.5px solid #d1d5db", "margin-bottom": "6px" })}"></div><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "700", "color": "#6b7280", "letter-spacing": "0.05em" })}">Sales Officer</div><div style="${ssrRenderStyle({ "font-size": "9px", "color": "#9ca3af", "margin-top": "2px" })}">Signature &amp; Stamp</div></div><div style="${ssrRenderStyle({ "text-align": "center" })}"><div style="${ssrRenderStyle({ "height": "32px", "border-bottom": "1.5px solid #d1d5db", "margin-bottom": "6px" })}"></div><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "700", "color": "#6b7280", "letter-spacing": "0.05em" })}">Accounts &amp; Finance</div><div style="${ssrRenderStyle({ "font-size": "9px", "color": "#9ca3af", "margin-top": "2px" })}">Signature &amp; Stamp</div></div></div><div style="${ssrRenderStyle({ "margin-top": "8px", "background": "#faf8f5", "border-top": "1px solid #f0ede8", "padding": "8px 40px" })}"><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#9ca3af" })}"> Generated by Ujjal FMC ERP \xB7 ${ssrInterpolate(unref(generatedAt))}</div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#9ca3af", "margin-top": "2px" })}">${ssrInterpolate(copyType === "customer" ? "Customer Copy \u2014 this is a computer-generated invoice and is valid without signature when processed through the ERP system." : "Office Copy \u2014 retain for company records.")}</div></div>`);
        if (copyType === "office") {
          _push(`<!--[--><div style="${ssrRenderStyle({ "margin": "14px 40px 0", "display": "flex", "align-items": "center", "gap": "10px", "color": "#9ca3af" })}"><span style="${ssrRenderStyle({ "font-size": "13px" })}">\u2702</span><div style="${ssrRenderStyle({ "flex": "1", "border-top": "1.5px dashed #d1d5db" })}"></div><span style="${ssrRenderStyle({ "font-size": "8.5px", "font-weight": "700", "letter-spacing": "0.08em", "text-transform": "uppercase" })}">Detach &amp; return signed GRN to office</span><div style="${ssrRenderStyle({ "flex": "1", "border-top": "1.5px dashed #d1d5db" })}"></div></div><div style="${ssrRenderStyle({ "margin": "10px 40px 0", "padding": "12px 18px 14px", "border": "1.5px solid #d97706", "border-radius": "10px", "background": "#fffbeb" })}"><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "800", "color": "#92400e", "letter-spacing": "0.1em", "text-transform": "uppercase", "margin-bottom": "8px" })}"> \u{1F4CB} Goods Receipt Note (GRN) \u2014 ${ssrInterpolate(unref(invoiceNo))}</div><div style="${ssrRenderStyle({ "font-size": "10.5px", "color": "#78350f", "line-height": "1.6", "margin-bottom": "10px" })}"> I acknowledge receipt of <span style="${ssrRenderStyle({ "display": "inline-block", "min-width": "40px", "border-bottom": "1px solid #b45309", "font-weight": "700", "text-align": "center" })}">\xA0</span> of ${ssrInterpolate(unref(totalBags))} bags ordered, in <span style="${ssrRenderStyle({ "display": "inline-block", "min-width": "80px", "border-bottom": "1px solid #b45309" })}">\xA0</span> condition. Remarks: <span style="${ssrRenderStyle({ "display": "inline-block", "min-width": "120px", "border-bottom": "1px solid #b45309" })}">\xA0</span></div><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "1fr 1fr 1fr", "gap": "20px" })}"><div><div style="${ssrRenderStyle({ "height": "28px", "border-bottom": "1.5px solid #b45309" })}"></div><div style="${ssrRenderStyle({ "font-size": "9px", "color": "#92400e", "margin-top": "3px" })}">Received By (Name)</div></div><div><div style="${ssrRenderStyle({ "height": "28px", "border-bottom": "1.5px solid #b45309" })}"></div><div style="${ssrRenderStyle({ "font-size": "9px", "color": "#92400e", "margin-top": "3px" })}">Date &amp; Time</div></div><div><div style="${ssrRenderStyle({ "height": "28px", "border-bottom": "1.5px solid #b45309" })}"></div><div style="${ssrRenderStyle({ "font-size": "9px", "color": "#92400e", "margin-top": "3px" })}">Signature &amp; Stamp</div></div></div></div><!--]-->`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
...
//# sourceMappingURL=invoice-Dax8gcXT.mjs.map
