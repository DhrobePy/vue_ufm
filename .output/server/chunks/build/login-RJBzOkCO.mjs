...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-860076d0>`);
      _push(ssrRenderComponent(_component_NuxtLayout, { name: "auth" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-full max-w-md mx-auto px-4 animate-slide-up" data-v-860076d0${_scopeId}><div class="relative rounded-3xl overflow-hidden" style="${ssrRenderStyle({ "background": "linear-gradient(145deg, rgba(28,24,20,0.9) 0%, rgba(18,15,12,0.95) 100%)", "border": "1px solid rgba(245,158,11,0.15)", "box-shadow": "0 24px 80px rgba(0,0,0,0.7), inset 0 1px 0 rgba(245,158,11,0.1)" })}" data-v-860076d0${_scopeId}><div class="h-px w-full" style="${ssrRenderStyle({ "background": "linear-gradient(90deg, transparent, #f59e0b 40%, #fbbf24 60%, transparent)" })}" data-v-860076d0${_scopeId}></div><div class="p-8" data-v-860076d0${_scopeId}><div class="flex flex-col items-center mb-8" data-v-860076d0${_scopeId}><div class="w-16 h-16 rounded-2xl flex items-center justify-center mb-4 animate-glow-pulse" style="${ssrRenderStyle({ "background": "linear-gradient(135deg, #f59e0b, #d97706)", "box-shadow": "0 0 32px rgba(245,158,11,0.4)" })}" data-v-860076d0${_scopeId}><span class="font-display font-bold text-black text-2xl" data-v-860076d0${_scopeId}>U</span></div><h1 class="font-display font-bold text-2xl text-white tracking-tight" data-v-860076d0${_scopeId}>Welcome back</h1><p class="text-sm text-gray-500 mt-1" data-v-860076d0${_scopeId}>Sign in to Ujjal FMC ERP</p></div><form class="space-y-4" data-v-860076d0${_scopeId}><div class="space-y-1.5" data-v-860076d0${_scopeId}><label class="text-xs font-semibold text-gray-400 uppercase tracking-wider" data-v-860076d0${_scopeId}>Email address</label><div class="relative" data-v-860076d0${_scopeId}><div class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-600" data-v-860076d0${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" data-v-860076d0${_scopeId}><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" data-v-860076d0${_scopeId}></path><polyline points="22,6 12,13 2,6" data-v-860076d0${_scopeId}></polyline></svg></div><input${ssrRenderAttr("value", unref(form).email)} type="email" placeholder="admin@ujjalfmc.com" class="${ssrRenderClass([unref(errors).email ? "border-red-500/50 focus:ring-red-500/30" : "", "input-glass pl-10"])}" data-v-860076d0${_scopeId}></div>`);
            if (unref(errors).email) {
              _push2(`<p class="text-xs text-red-400" data-v-860076d0${_scopeId}>${ssrInterpolate(unref(errors).email)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="space-y-1.5" data-v-860076d0${_scopeId}><label class="text-xs font-semibold text-gray-400 uppercase tracking-wider" data-v-860076d0${_scopeId}>Password</label><div class="relative" data-v-860076d0${_scopeId}><div class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-600" data-v-860076d0${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" data-v-860076d0${_scopeId}><rect x="3" y="11" width="18" height="11" rx="2" ry="2" data-v-860076d0${_scopeId}></rect><path d="M7 11V7a5 5 0 0110 0v4" data-v-860076d0${_scopeId}></path></svg></div><input${ssrRenderDynamicModel(unref(showPassword) ? "text" : "password", unref(form).password, null)}${ssrRenderAttr("type", unref(showPassword) ? "text" : "password")} placeholder="\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022" class="${ssrRenderClass([unref(errors).password ? "border-red-500/50 focus:ring-red-500/30" : "", "input-glass pl-10 pr-10"])}" data-v-860076d0${_scopeId}><button type="button" class="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-400 transition-colors duration-150" data-v-860076d0${_scopeId}>`);
            if (!unref(showPassword)) {
              _push2(`<svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" data-v-860076d0${_scopeId}><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" data-v-860076d0${_scopeId}></path><circle cx="12" cy="12" r="3" data-v-860076d0${_scopeId}></circle></svg>`);
            } else {
              _push2(`<svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" data-v-860076d0${_scopeId}><path d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24M1 1l22 22" data-v-860076d0${_scopeId}></path></svg>`);
            }
            _push2(`</button></div>`);
            if (unref(errors).password) {
              _push2(`<p class="text-xs text-red-400" data-v-860076d0${_scopeId}>${ssrInterpolate(unref(errors).password)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="flex items-center justify-between pt-1" data-v-860076d0${_scopeId}><label class="flex items-center gap-2 cursor-pointer group" data-v-860076d0${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(unref(form).remember) ? ssrLooseContain(unref(form).remember, null) : unref(form).remember) ? " checked" : ""} type="checkbox" class="w-4 h-4 rounded border-white/20 bg-white/[0.05] text-gold-500 focus:ring-gold-500/40" data-v-860076d0${_scopeId}><span class="text-xs text-gray-500 group-hover:text-gray-300 transition-colors" data-v-860076d0${_scopeId}>Remember me</span></label><button type="button" class="text-xs text-gold-500/80 hover:text-gold-400 transition-colors duration-150" data-v-860076d0${_scopeId}> Forgot password? </button></div>`);
            if (unref(loginError)) {
              _push2(`<div class="flex items-center gap-2.5 px-3.5 py-3 rounded-xl text-sm text-red-300" style="${ssrRenderStyle({ "background": "rgba(239,68,68,0.1)", "border": "1px solid rgba(239,68,68,0.2)" })}" data-v-860076d0${_scopeId}><svg class="w-4 h-4 shrink-0 text-red-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-860076d0${_scopeId}><circle cx="12" cy="12" r="10" data-v-860076d0${_scopeId}></circle><line x1="12" y1="8" x2="12" y2="12" data-v-860076d0${_scopeId}></line><line x1="12" y1="16" x2="12.01" y2="16" data-v-860076d0${_scopeId}></line></svg> ${ssrInterpolate(unref(loginError))}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} class="btn-gold w-full justify-center py-3 text-sm font-semibold mt-2" data-v-860076d0${_scopeId}>`);
            if (unref(loading)) {
              _push2(`<svg class="w-4 h-4 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-860076d0${_scopeId}><path d="M12 2a10 10 0 110 20A10 10 0 0112 2zm0 2a8 8 0 100 16A8 8 0 0012 4z" stroke-opacity=".2" data-v-860076d0${_scopeId}></path><path d="M12 2a10 10 0 0110 10h-2A8 8 0 0012 4V2z" data-v-860076d0${_scopeId}></path></svg>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<span data-v-860076d0${_scopeId}>${ssrInterpolate(unref(loading) ? "Signing in\u2026" : "Sign in")}</span>`);
            if (!unref(loading)) {
              _push2(`<svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-860076d0${_scopeId}><path d="M5 12h14M12 5l7 7-7 7" data-v-860076d0${_scopeId}></path></svg>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</button></form></div><div class="px-8 pb-6 text-center" data-v-860076d0${_scopeId}><p class="text-[11px] text-gray-700" data-v-860076d0${_scopeId}> Ujjal Flour Mills Company \xA9 ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} \xB7 ERP v1.0 </p></div></div><p class="text-center text-[11px] text-gray-700 mt-4" data-v-860076d0${_scopeId}> Secured with end-to-end session encryption </p></div>`);
          } else {
            return [
...
const login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-860076d0"]]);

export { login as default };
//# sourceMappingURL=login-RJBzOkCO.mjs.map
