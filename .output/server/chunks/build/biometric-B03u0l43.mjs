...
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderStyle, ssrRenderTeleport, ssrRenderComponent } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 space-y-5" }, _attrs))}><div class="flex items-center justify-between flex-wrap gap-3"><div><h1 class="text-2xl font-bold text-white">Biometric Devices</h1><p class="text-sm text-gray-400">Hardware attendance terminals \u2014 ZKTeco, Hikvision, Dahua, eSSL, FingerTec &amp; more</p></div><button class="btn-primary">+ Add Device</button></div><div class="flex gap-1 border-b border-white/[0.07] pb-0"><!--[-->`);
...
//# sourceMappingURL=biometric-B03u0l43.mjs.map
