...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="glass-card p-4 flex flex-wrap items-center gap-3"><input${ssrRenderAttr("value", unref(search))} type="text" class="field-input text-xs py-1.5 w-52" placeholder="Search order #, customer\u2026"><select class="field-input text-xs py-1.5 w-36"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(priorityFilter)) ? ssrLooseContain(unref(priorityFilter), "") : ssrLooseEqual(unref(priorityFilter), "")) ? " selected" : ""}>All Priorities</option><option value="urgent"${ssrIncludeBooleanAttr(Array.isArray(unref(priorityFilter)) ? ssrLooseContain(unref(priorityFilter), "urgent") : ssrLooseEqual(unref(priorityFilter), "urgent")) ? " selected" : ""}>Urgent</option><option value="high"${ssrIncludeBooleanAttr(Array.isArray(unref(priorityFilter)) ? ssrLooseContain(unref(priorityFilter), "high") : ssrLooseEqual(unref(priorityFilter), "high")) ? " selected" : ""}>High</option><option value="normal"${ssrIncludeBooleanAttr(Array.isArray(unref(priorityFilter)) ? ssrLooseContain(unref(priorityFilter), "normal") : ssrLooseEqual(unref(priorityFilter), "normal")) ? " selected" : ""}>Normal</option></select><button class="btn-ghost text-xs py-1.5">Reset</button><div class="ml-auto flex items-center gap-3 text-xs text-gray-500"><span class="font-medium text-gray-300">${ssrInterpolate((_b = (_a = unref(data)) == null ? void 0 : _a.total) != null ? _b : 0)}</span> orders </div></div>`);
      if (unref(pending)) {
...
//# sourceMappingURL=all-BVK8OosQ.mjs.map
