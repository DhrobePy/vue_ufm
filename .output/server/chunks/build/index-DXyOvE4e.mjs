...
import { _ as _sfc_main$4 } from './StatusBadge-C6rBgLMJ.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    function scheduleTooBatch(s) {
      ...
      return {
        id: `PS-${s.id}`,
        product: (_b2 = s.order_number) != null ? _b2 : "\u2014",
        orderId: (_c2 = s.order_number) != null ? _c2 : "\u2014",
        customer: (_d2 = s.customer_name) != null ? _d2 : "\u2014",
        targetBags: kg > 0 ? Math.round(kg / 50) : 200,
        doneBags: 0,
        status: s.status === "in_progress" ? "running" : "paused",
        shift: "\u2014",
        machine: "\u2014",
        operator: (_e = s.manager_name) != null ? _e : "\u2014"
      };
    }
...
//# sourceMappingURL=index-DXyOvE4e.mjs.map
