...
import { defineComponent, ref, watch, mergeProps, unref, computed, withCtx, openBlock, createBlock, createCommentVNode, createVNode, createTextVNode, nextTick, Transition, toDisplayString, useSSRContext } from 'vue';
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-e0230ba9><div class="absolute top-0 left-0 right-0 h-[2px]" style="${ssrRenderStyle({ "background": "linear-gradient(90deg, transparent, var(--accent-from), transparent)" })}" data-v-e0230ba9></div><div class="absolute top-0 left-0 w-full h-64 pointer-events-none" style="${ssrRenderStyle({ "background": "radial-gradient(ellipse at top left, rgba(var(--accent-glow),0.06) 0%, transparent 70%)" })}" data-v-e0230ba9></div><div class="${ssrRenderClass([__props.collapsed ? "justify-center" : "justify-between", "relative flex items-center h-16 px-4 shrink-0"])}" data-v-e0230ba9><div class="flex items-center gap-3 overflow-hidden" data-v-e0230ba9><div class="shrink-0 w-9 h-9 rounded-xl flex items-center justify-center animate-glow-pulse" style="${ssrRenderStyle(`background: linear-gradient(135deg, var(--accent-from), var(--accent-to)); box-shadow: 0 0 16px rgba(var(--accent-glow),0.4)`)}" data-v-e0230ba9><span class="font-display font-bold text-base leading-none" style="${ssrRenderStyle(`color: var(--accent-text)`)}" data-v-e0230ba9>U</span></div>`);
      if (!__props.collapsed) {
        _push(`<div class="flex flex-col" data-v-e0230ba9><span class="font-display font-bold text-sm text-white leading-tight tracking-tight" data-v-e0230ba9>Ujjal FMC</span><span class="text-[10px] font-medium uppercase tracking-widest leading-tight" style="${ssrRenderStyle(`color: var(--accent-from); opacity: 0.8`)}" data-v-e0230ba9>ERP System</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (!__props.collapsed) {
        _push(`<button class="w-7 h-7 rounded-lg flex items-center justify-center text-gray-500 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150 shrink-0" data-v-e0230ba9><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-e0230ba9><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" data-v-e0230ba9></path></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="mx-4 h-px bg-white/[0.06]" data-v-e0230ba9></div><nav class="flex-1 overflow-y-auto no-scrollbar py-3 px-2 space-y-0.5" data-v-e0230ba9>`);
      ...
      if (unref(showOperations)) {
        _push(`<div class="py-1" data-v-e0230ba9>`);
        if (!__props.collapsed) {
          _push(`<div class="px-3 mb-1" data-v-e0230ba9><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-e0230ba9>Operations</span></div>`);
        } else {
          _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-e0230ba9></div>`);
        }
        _push(`</div>`);
      } else {
        _push(`<!---->`);
            ...
            if (_push2) {
              ...
              if (unref(isAdminUser)) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  ...
                  route: "/credit-sales/backdated-entry",
                  collapsed: __props.collapsed,
                  "icon-type": "clock",
                  sub: ""
                }, null, _parent2, _scopeId));
      ...
      if (unref(isAdminUser) || unref(perms).canAccessModule("trading")) {
        _push(ssrRenderComponent(_component_SidebarGroup, {
          label: "Trading",
          route: "/trading",
          collapsed: __props.collapsed,
      ...
      if (unref(isAdminUser) || unref(perms).canAccessModule("loans")) {
        _push(ssrRenderComponent(_component_SidebarGroup, {
          label: "Loans",
          route: "/loans",
          collapsed: __props.collapsed,
        ...
        _push(ssrRenderComponent(_component_SidebarGroup, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (unref(perms).canAccessRoute("/fleet/rentals")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  label: "Rentals",
                  route: "/fleet/rentals",
                  collapsed: __props.collapsed,
              ...
              return [
                ...
                unref(perms).canAccessRoute("/fleet/rentals") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 4,
                  label: "Rentals",
                  route: "/fleet/rentals",
                  collapsed: __props.collapsed,
        ...
        _push(ssrRenderComponent(_component_SidebarGroup, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (unref(perms).canAccessRoute("/purchase/commodities")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  label: "Commodities",
              ...
              return [
                ...
                unref(perms).canAccessRoute("/purchase/commodities") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 9,
                  label: "Commodities",
                  route: "/purchase/commodities",
                  collapsed: __props.collapsed,
      ...
      if (unref(showFinance)) {
        _push(`<div class="py-1" data-v-e0230ba9>`);
        if (!__props.collapsed) {
          _push(`<div class="px-3 mb-1" data-v-e0230ba9><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-e0230ba9>Finance</span></div>`);
        } else {
          _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-e0230ba9></div>`);
        }
        _push(`</div>`);
        ...
        _push(ssrRenderComponent(_component_SidebarGroup, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (unref(perms).canAccessRoute("/bank/reconciliation")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
              ...
              return [
                ...
                unref(perms).canAccessRoute("/bank/reconciliation") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 4,
                  label: "Reconciliation",
                  route: "/bank/reconciliation",
                  collapsed: __props.collapsed,
        ...
        _push(ssrRenderComponent(_component_SidebarGroup, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (unref(perms).canAccessRoute("/accounts/tax-statement")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  label: "Tax Statement",
                  route: "/accounts/tax-statement",
                  collapsed: __props.collapsed,
                  "icon-type": "file",
                  sub: ""
                }, null, _parent2, _scopeId));
              ...
              if (unref(perms).canAccessRoute("/accounts/day-end-reconciliation")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  label: "Day-End Reconciliation",
                  route: "/accounts/day-end-reconciliation",
                  collapsed: __props.collapsed,
                  "icon-type": "check",
                  sub: ""
                }, null, _parent2, _scopeId));
              ...
              return [
                ...
                unref(perms).canAccessRoute("/accounts/tax-statement") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 3,
                  label: "Tax Statement",
                  route: "/accounts/tax-statement",
                  collapsed: __props.collapsed,
                ...
                unref(perms).canAccessRoute("/accounts/day-end-reconciliation") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 6,
                  label: "Day-End Reconciliation",
                  route: "/accounts/day-end-reconciliation",
                  collapsed: __props.collapsed,
      ...
      if (unref(showStandalone)) {
        _push(`<div class="py-1" data-v-e0230ba9>`);
        if (!__props.collapsed) {
          _push(`<div class="px-3 mb-1" data-v-e0230ba9><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-e0230ba9>Standalone Modules</span></div>`);
        } else {
          _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-e0230ba9></div>`);
        }
        _push(`</div>`);
      ...
      if (unref(showMore)) {
        _push(`<div class="py-1" data-v-e0230ba9>`);
        if (!__props.collapsed) {
          _push(`<div class="px-3 mb-1" data-v-e0230ba9><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-e0230ba9>More</span></div>`);
        } else {
          _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-e0230ba9></div>`);
        }
        _push(`</div>`);
      ...
      if (unref(perms).canAccessModule("pos")) {
        _push(ssrRenderComponent(_component_SidebarGroup, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(perms).canAccessRoute("/pos")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  label: "Terminal",
                  route: "/pos",
                  collapsed: __props.collapsed,
              ...
              if (unref(perms).canAccessRoute("/pos/dashboard")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  label: "Dashboard",
                  route: "/pos/dashboard",
                  collapsed: __props.collapsed,
              ...
              if (unref(perms).canAccessRoute("/pos/today")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  label: "Today",
                  route: "/pos/today",
                  collapsed: __props.collapsed,
              ...
              if (unref(perms).canAccessRoute("/pos/reports")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  label: "Reports",
                  route: "/pos/reports",
                  collapsed: __props.collapsed,
              ...
              if (unref(perms).canAccessRoute("/pos/eod")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  label: "End of Day",
                  route: "/pos/eod",
                  collapsed: __props.collapsed,
              ...
              if (unref(perms).canAccessRoute("/pos/pending-approvals")) {
                _push2(ssrRenderComponent(_component_SidebarNavItem, {
                  label: "Pending Approvals",
                  route: "/pos/pending-approvals",
                  collapsed: __props.collapsed,
                  "icon-type": "clock",
                  sub: ""
                }, null, _parent2, _scopeId));
              ...
              return [
                unref(perms).canAccessRoute("/pos") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 0,
                  label: "Terminal",
                  route: "/pos",
                  collapsed: __props.collapsed,
                ...
                unref(perms).canAccessRoute("/pos/dashboard") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 1,
                  label: "Dashboard",
                  route: "/pos/dashboard",
                  collapsed: __props.collapsed,
                ...
                unref(perms).canAccessRoute("/pos/today") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 2,
                  label: "Today",
                  route: "/pos/today",
                  collapsed: __props.collapsed,
                ...
                unref(perms).canAccessRoute("/pos/reports") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 3,
                  label: "Reports",
                  route: "/pos/reports",
                  collapsed: __props.collapsed,
                ...
                unref(perms).canAccessRoute("/pos/eod") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 4,
                  label: "End of Day",
                  route: "/pos/eod",
                  collapsed: __props.collapsed,
                ...
                unref(perms).canAccessRoute("/pos/pending-approvals") ? (openBlock(), createBlock(_component_SidebarNavItem, {
                  key: 5,
                  label: "Pending Approvals",
                  route: "/pos/pending-approvals",
                  collapsed: __props.collapsed,
      ...
      if (unref(showHR)) {
        _push(`<div class="py-1" data-v-e0230ba9>`);
        if (!__props.collapsed) {
          _push(`<div class="px-3 mb-1" data-v-e0230ba9><span class="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-600" data-v-e0230ba9>Human Resources</span></div>`);
        } else {
          _push(`<div class="mx-auto w-6 h-px bg-white/[0.06] my-2" data-v-e0230ba9></div>`);
        }
        _push(`</div>`);
      ...
      _push(`</nav><div class="shrink-0 mx-2 mb-3" data-v-e0230ba9><div class="h-px bg-white/[0.06] mb-3" data-v-e0230ba9></div><div class="${ssrRenderClass([
      ...
      ])}" data-v-e0230ba9><div class="shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold" style="${ssrRenderStyle(`background: linear-gradient(135deg, var(--accent-from), var(--accent-to)); color: var(--accent-text)`)}" data-v-e0230ba9>${ssrInterpolate(unref(initials))}</div>`);
      if (!__props.collapsed) {
        _push(`<div class="flex-1 min-w-0" data-v-e0230ba9><p class="text-sm font-medium text-gray-200 truncate leading-tight" data-v-e0230ba9>${ssrInterpolate(((_a = unref(sessionUser)) == null ? void 0 : _a.name) || "User")}</p><p class="text-[11px] text-gray-500 truncate leading-tight font-mono" data-v-e0230ba9>${ssrInterpolate(((_b = unref(sessionUser)) == null ? void 0 : _b.role) || "")}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!__props.collapsed) {
        _push(`<button class="w-7 h-7 rounded-lg flex items-center justify-center text-gray-600 hover:text-red-400 hover:bg-red-500/10 transition-all duration-150 shrink-0" data-v-e0230ba9><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-e0230ba9><path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h6a2 2 0 012 2v1" data-v-e0230ba9></path></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (__props.collapsed) {
        _push(`<button class="mt-1 w-full h-8 rounded-xl flex items-center justify-center text-gray-600 hover:text-gray-200 hover:bg-white/[0.07] transition-all duration-150" data-v-e0230ba9><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" data-v-e0230ba9><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" data-v-e0230ba9></path></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></aside>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-e0230ba9"]]);
...
const PAGES = [
  ...
  { type: "page", icon: "\u{1F4E6}", label: "Trading Dashboard", route: "/trading/dashboard" },
  { type: "page", icon: "\u{1F4E6}", label: "Trading Sales", route: "/trading/sales" },
  { type: "page", icon: "\u{1F91D}", label: "Loans", route: "/loans" },
...
function useGlobalSearch() {
  ...
  watch(query, (q) => {
    ...
    debounceTimer = setTimeout(async () => {
      ...
      try {
        const res = await $fetch("/api/search", { query: { q: term } });
        if (seq === requestSeq) dynamicResults.value = (_a = res.results) != null ? _a : [];
      } catch {
...
//# sourceMappingURL=default-Kf0P6-G4.mjs.map
