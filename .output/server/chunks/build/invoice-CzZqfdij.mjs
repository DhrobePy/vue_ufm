...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></tbody></table></div><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "1fr 300px", "gap": "0", "border-top": "2px solid #f0ede8", "margin": "0 40px 0 40px", "padding-top": "16px", "padding-bottom": "16px" })}"><div style="${ssrRenderStyle({ "padding-right": "32px" })}"><div style="${ssrRenderStyle({ "font-size": "9px", "font-weight": "800", "color": "#9ca3af", "letter-spacing": "0.12em", "text-transform": "uppercase", "margin-bottom": "8px" })}">Notes &amp; Terms</div><div style="${ssrRenderStyle({ "font-size": "11px", "color": "#6b7280", "line-height": "1.8" })}">`);
      ...
      _push(`<div style="${ssrRenderStyle({ "margin": "0 40px", "padding": "10px 0 0", "border-top": "1px solid #f0ede8", "display": "grid", "grid-template-columns": "1fr 1fr 1.2fr", "gap": "24px" })}"><div style="${ssrRenderStyle({ "text-align": "center" })}"><div style="${ssrRenderStyle({ "height": "32px", "border-bottom": "1.5px solid #d1d5db", "margin-bottom": "6px" })}"></div><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "700", "color": "#6b7280", "letter-spacing": "0.05em" })}">Sales Officer</div><div style="${ssrRenderStyle({ "font-size": "9px", "color": "#9ca3af", "margin-top": "2px" })}">Signature &amp; Stamp</div></div><div style="${ssrRenderStyle({ "text-align": "center" })}"><div style="${ssrRenderStyle({ "height": "32px", "border-bottom": "1.5px solid #d1d5db", "margin-bottom": "6px" })}"></div><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "700", "color": "#6b7280", "letter-spacing": "0.05em" })}">Accounts &amp; Finance</div><div style="${ssrRenderStyle({ "font-size": "9px", "color": "#9ca3af", "margin-top": "2px" })}">Signature &amp; Stamp</div></div><div style="${ssrRenderStyle({ "text-align": "center", "padding": "6px 10px 4px", "border": "1.5px solid #d97706", "border-radius": "8px", "background": "#fffbeb" })}"><div style="${ssrRenderStyle({ "height": "26px", "border-bottom": "1.5px solid #b45309", "margin-bottom": "5px" })}"></div><div style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "800", "color": "#92400e", "letter-spacing": "0.05em" })}">GRN \u2014 Received By (Customer)</div><div style="${ssrRenderStyle({ "font-size": "8.5px", "color": "#92400e", "margin-top": "2px" })}"> Qty received: <span style="${ssrRenderStyle({ "display": "inline-block", "min-width": "26px", "border-bottom": "1px solid #b45309" })}">\xA0</span>/${ssrInterpolate(unref(totalBags))} bags \xB7 Condition: Good \u2610 Damaged \u2610 \xB7 Date: <span style="${ssrRenderStyle({ "display": "inline-block", "min-width": "50px", "border-bottom": "1px solid #b45309" })}">\xA0</span></div></div></div><div style="${ssrRenderStyle({ "margin-top": "8px", "background": "#faf8f5", "border-top": "1px solid #f0ede8", "padding": "8px 40px", "display": "flex", "align-items": "center", "justify-content": "space-between" })}"><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#9ca3af" })}"> Generated by Ujjal FMC ERP \xB7 ${ssrInterpolate(unref(generatedAt))}</div><div style="${ssrRenderStyle({ "font-size": "10px", "color": "#9ca3af", "text-align": "center" })}"> This is a computer-generated invoice and is valid without signature<br> when processed through the ERP system. </div>`);
      if (!unref(isDelivered)) {
        _push(`<div style="${ssrRenderStyle({ "text-align": "right" })}">`);
        if (unref(qrDataUrl)) {
          _push(`<img${ssrRenderAttr("src", unref(qrDataUrl))} style="${ssrRenderStyle({ "width": "52px", "height": "52px", "border-radius": "6px", "border": "1px solid #e5e7eb", "display": "block", "margin-left": "auto" })}">`);
        } else {
          _push(`<div style="${ssrRenderStyle({ "width": "52px", "height": "52px", "background": "#f3f4f6", "border": "1px solid #e5e7eb", "border-radius": "6px", "margin-left": "auto" })}"></div>`);
        }
        _push(`<div style="${ssrRenderStyle({ "font-size": "7px", "color": "#9ca3af", "margin-top": "2px", "text-align": "center" })}">Scan for gate pass &amp; delivery</div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=invoice-CzZqfdij.mjs.map
