...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></select><input type="date"${ssrRenderAttr("value", unref(dateFrom))} class="input-glass w-40"><input type="date"${ssrRenderAttr("value", unref(dateTo))} class="input-glass w-40"><button class="btn-ghost text-xs">Filter</button><button class="btn-gold text-xs">Export</button></div>`);
      if (unref(pending)) {
...
//# sourceMappingURL=ledger-D79XvKqe.mjs.map
