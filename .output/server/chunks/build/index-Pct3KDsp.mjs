  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(`<!--]--></div><div class="glass-card p-5"><div class="flex items-center justify-between mb-4"><h2 class="section-title">Pending Transactions</h2><span class="text-xs text-yellow-400 font-medium">Awaiting approval</span></div>`);
...
//# sourceMappingURL=index-Pct3KDsp.mjs.map
