import { q as defineEventHandler, X as getUserSession, b as ADMIN_ROLES, A as ACCOUNTS_ROLES, m as createError, aq as readBody, an as query } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
