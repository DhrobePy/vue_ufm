import { q as defineEventHandler, X as getUserSession, m as createError, a0 as isAccountsRole, a1 as isAdminRole, J as getQuery, ap as query, aq as queryOne } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
