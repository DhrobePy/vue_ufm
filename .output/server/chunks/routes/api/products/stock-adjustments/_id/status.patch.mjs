import { q as defineEventHandler, R as getRouterParam, m as createError, X as getUserSession, b as ADMIN_ROLES, aq as readBody, z as getDb, E as getGLAccountId, aj as postJournalEntry, g as auditLog, aG as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
