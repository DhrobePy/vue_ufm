import { n as defineEventHandler, I as getRouterParam, j as createError, L as getUserSession, a as ADMIN_ROLES, a9 as readBody, u as getDb, w as getGLAccountId, a4 as postJournalEntry, e as auditLog, ag as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
