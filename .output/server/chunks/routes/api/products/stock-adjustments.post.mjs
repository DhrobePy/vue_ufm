import { n as defineEventHandler, aa as readBody, N as getUserSession, j as createError, v as getDb, X as nextDocNumber, e as auditLog, an as sendTelegram } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
