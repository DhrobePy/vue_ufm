import { n as defineEventHandler, ab as readBody, N as getUserSession, j as createError, v as getDb, Y as nextDocNumber, e as auditLog, ap as sendTelegram } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
