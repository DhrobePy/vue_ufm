import { o as defineEventHandler, af as readBody, Q as getUserSession, k as createError, x as getDb, _ as nextDocNumber, e as auditLog, au as sendTelegram } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
