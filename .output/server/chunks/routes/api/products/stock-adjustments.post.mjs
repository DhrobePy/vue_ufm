import { q as defineEventHandler, as as readBody, X as getUserSession, m as createError, z as getDb, a6 as nextDocNumber, g as auditLog, aJ as sendTelegram } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
