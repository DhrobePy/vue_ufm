import { o as defineEventHandler, ac as readBody, O as getUserSession, k as createError, w as getDb, Z as nextDocNumber, e as auditLog, aq as sendTelegram } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
