import { n as defineEventHandler, N as getUserSession, j as createError, C as getQuery, v as getDb, ap as verifyDeliveryQrSignature, B as getOrderGateState, E as getRequestHeader, ae as recordQrScan, a as ADMIN_ROLES, A as ACCOUNTS_ROLES, D as DISPATCH_ROLES, P as PRODUCTION_ROLES } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
