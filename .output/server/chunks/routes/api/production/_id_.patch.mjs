import { q as defineEventHandler, X as getUserSession, e as PRODUCTION_ROLES, b as ADMIN_ROLES, A as ACCOUNTS_ROLES, m as createError, ar as readBody, z as getDb, g as auditLog, aI as sendTelegram } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
