import { q as defineEventHandler, R as getRouterParam, ar as readBody, X as getUserSession, m as createError, z as getDb, k as checkTransactionLimit, aq as queuePendingRequest, aH as sendTelegram, E as getGLAccountId, ak as postJournalEntry, g as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
