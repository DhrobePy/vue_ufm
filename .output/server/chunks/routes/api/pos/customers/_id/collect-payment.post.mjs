import { q as defineEventHandler, R as getRouterParam, aq as readBody, X as getUserSession, m as createError, z as getDb, k as checkTransactionLimit, ap as queuePendingRequest, aG as sendTelegram, E as getGLAccountId, aj as postJournalEntry, g as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
