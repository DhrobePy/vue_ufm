import { p as defineEventHandler, O as getRouterParam, am as readBody, V as getUserSession, l as createError, y as getDb, j as checkTransactionLimit, al as queuePendingRequest, aC as sendTelegram, C as getGLAccountId, ag as postJournalEntry, f as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
