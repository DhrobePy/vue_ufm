import { q as defineEventHandler, X as getUserSession, m as createError, a1 as isAdminRole, R as getRouterParam, ar as readBody, z as getDb, ax as recycleBegin, aB as recycleSnapshotBefore, aw as recycleArchiveDelete, ay as recycleFinalize, g as auditLog, aH as sendTelegram } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
