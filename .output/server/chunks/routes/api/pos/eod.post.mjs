import { q as defineEventHandler, X as getUserSession, m as createError, ar as readBody, z as getDb, a1 as isAdminRole, g as auditLog, aI as sendTelegram } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
