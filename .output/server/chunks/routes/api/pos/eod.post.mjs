import { p as defineEventHandler, V as getUserSession, l as createError, am as readBody, y as getDb, _ as isAdminRole, f as auditLog, aC as sendTelegram } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
