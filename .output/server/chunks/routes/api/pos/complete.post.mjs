import { q as defineEventHandler, aq as readBody, X as getUserSession, m as createError, P as POS_VALID_METHODS, z as getDb, I as getPosCustomerOutstanding, ap as queuePendingRequest, aG as sendTelegram, al as postPosSale, g as auditLog, B as getDeliveryQrSecret, ac as posExitQrSignature, M as getRequestURL, a1 as isAdminRole } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
