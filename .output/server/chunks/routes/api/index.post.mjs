import { n as defineEventHandler, a7 as readBody, K as getUserSession, z as getRequestHeader, j as createError, u as getDb, t as getCustomerOutstanding, e as auditLog, ad as sendTelegram } from '../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
