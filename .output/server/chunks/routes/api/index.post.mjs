import { m as defineEventHandler, a4 as readBody, K as getUserSession, z as getRequestHeader, i as createError, u as getDb, t as getCustomerOutstanding, e as auditLog, aa as sendTelegram } from '../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
