import { n as defineEventHandler, a9 as readBody, L as getUserSession, B as getRequestHeader, j as createError, u as getDb, t as getCustomerOutstanding, e as auditLog, ag as sendTelegram } from '../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
