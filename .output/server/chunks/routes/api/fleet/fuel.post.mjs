import { q as defineEventHandler, X as getUserSession, ar as readBody, m as createError, ap as queryOne, z as getDb, ai as postFleetExpenseGl } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
