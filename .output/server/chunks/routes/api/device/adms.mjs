import { h as defineEventHandler, R as setResponseHeader, o as getMethod, p as getQuery, s as getRequestURL, O as readRawBody, n as getDb, L as queryOne } from '../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
