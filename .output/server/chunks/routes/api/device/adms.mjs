import { j as defineEventHandler, a5 as setResponseHeader, s as getMethod, u as getQuery, x as getRequestURL, a1 as readRawBody, q as getDb, Z as queryOne } from '../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
