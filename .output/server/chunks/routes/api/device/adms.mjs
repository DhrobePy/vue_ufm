import { q as defineEventHandler, aJ as setResponseHeader, G as getMethod, J as getQuery, M as getRequestURL, as as readRawBody, z as getDb, ao as queryOne } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
