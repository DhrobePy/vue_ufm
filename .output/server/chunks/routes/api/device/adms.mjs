import { o as defineEventHandler, ax as setResponseHeader, C as getMethod, F as getQuery, I as getRequestURL, ah as readRawBody, x as getDb, ad as queryOne } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
