import { q as defineEventHandler, aM as setResponseHeader, G as getMethod, J as getQuery, M as getRequestURL, au as readRawBody, z as getDb, aq as queryOne } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
