import { o as defineEventHandler, aw as setResponseHeader, B as getMethod, E as getQuery, H as getRequestURL, ag as readRawBody, w as getDb, ac as queryOne } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
