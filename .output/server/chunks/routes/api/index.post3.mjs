import { o as defineEventHandler, ac as readBody, O as getUserSession, k as createError, w as getDb, aa as queryOne, e as auditLog, a1 as notifyAdmins } from '../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
