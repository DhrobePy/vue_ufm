import { q as defineEventHandler, aq as readBody, X as getUserSession, m as createError, z as getDb, a5 as nextDocNumber, ao as queryOne, g as auditLog, a8 as notifyAdmins } from '../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
