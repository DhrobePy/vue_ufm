import { o as defineEventHandler, af as readBody, Q as getUserSession, k as createError, x as getDb, ad as queryOne, e as auditLog, a2 as notifyAdmins } from '../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
