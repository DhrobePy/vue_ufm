import { p as defineEventHandler, am as readBody, V as getUserSession, l as createError, aJ as userCanAction, b as ADMIN_ROLES, A as ACCOUNTS_ROLES, y as getDb, a3 as nextDocNumber, C as getGLAccountId, ag as postJournalEntry, ae as postCustomerLedger, f as auditLog, aC as sendTelegram } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
