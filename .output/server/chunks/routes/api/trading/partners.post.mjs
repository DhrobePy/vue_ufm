import { q as defineEventHandler, ar as readBody, X as getUserSession, m as createError, aP as userCanAction, b as ADMIN_ROLES, A as ACCOUNTS_ROLES, z as getDb, g as auditLog } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
