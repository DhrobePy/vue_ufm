import { q as defineEventHandler, aq as readBody, X as getUserSession, m as createError, aN as userCanAction, b as ADMIN_ROLES, A as ACCOUNTS_ROLES, z as getDb, g as auditLog } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
