import { m as defineEventHandler, H as getRouterParam, i as createError, K as getUserSession, z as getRequestHeader, u as getDb, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
