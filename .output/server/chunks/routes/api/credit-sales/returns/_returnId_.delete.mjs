import { q as defineEventHandler, R as getRouterParam, m as createError, X as getUserSession, K as getRequestHeader, z as getDb, az as recycleBegin, aK as serializeRow, aD as recycleSnapshotBefore, ay as recycleArchiveDelete, aA as recycleFinalize, g as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
