import { o as defineEventHandler, M as getRouterParam, k as createError, Q as getUserSession, af as readBody, G as getRequestHeader, x as getDb, e as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
