import { o as defineEventHandler, L as getRouterParam, k as createError, O as getUserSession, ac as readBody, F as getRequestHeader, w as getDb, e as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
