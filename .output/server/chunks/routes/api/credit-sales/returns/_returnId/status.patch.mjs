import { h as defineEventHandler, w as getRouterParam, e as createError, x as getUserSession, M as readBody, q as getRequestHeader, n as getDb, a as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
