import { n as defineEventHandler, K as getRouterParam, j as createError, N as getUserSession, ab as readBody, E as getRequestHeader, v as getDb, e as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
