import { n as defineEventHandler, I as getRouterParam, a9 as readBody, L as getUserSession, j as createError, Q as isAccountsRole, u as getDb, e as auditLog, ag as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
