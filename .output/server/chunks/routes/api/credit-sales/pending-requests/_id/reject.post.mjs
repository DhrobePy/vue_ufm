import { q as defineEventHandler, R as getRouterParam, ar as readBody, X as getUserSession, m as createError, a0 as isAccountsRole, z as getDb, g as auditLog, aI as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
