import { o as defineEventHandler, L as getRouterParam, ae as readBody, O as getUserSession, k as createError, U as isAccountsRole, w as getDb, e as auditLog, at as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
