import { n as defineEventHandler, H as getRouterParam, a7 as readBody, K as getUserSession, j as createError, O as isAccountsRole, u as getDb, e as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
