import { o as defineEventHandler, Q as getUserSession, k as createError, a as ADMIN_ROLES, af as readBody, x as getDb, a8 as postCustomerLedger, e as auditLog, au as sendTelegram } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
