import { q as defineEventHandler, X as getUserSession, m as createError, b as ADMIN_ROLES, aq as readBody, z as getDb, ah as postCustomerLedger, g as auditLog, aG as sendTelegram } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
