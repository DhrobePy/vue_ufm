import { p as defineEventHandler, V as getUserSession, l as createError, b as ADMIN_ROLES, am as readBody, y as getDb, ae as postCustomerLedger, f as auditLog, aC as sendTelegram } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
