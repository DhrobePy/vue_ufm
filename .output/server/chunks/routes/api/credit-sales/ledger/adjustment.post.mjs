import { o as defineEventHandler, O as getUserSession, k as createError, a as ADMIN_ROLES, ac as readBody, w as getDb, a5 as postCustomerLedger, e as auditLog, aq as sendTelegram } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
