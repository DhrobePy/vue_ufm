import { q as defineEventHandler, X as getUserSession, m as createError, b as ADMIN_ROLES, ar as readBody, z as getDb, ah as postCustomerLedger, g as auditLog, aI as sendTelegram } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
