import { n as defineEventHandler, N as getUserSession, j as createError, a as ADMIN_ROLES, ab as readBody, v as getDb, a4 as postCustomerLedger, e as auditLog, ao as sendTelegram } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
