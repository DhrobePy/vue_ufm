import { n as defineEventHandler, N as getUserSession, j as createError, a as ADMIN_ROLES, aa as readBody, v as getDb, a3 as postCustomerLedger, e as auditLog, an as sendTelegram } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
