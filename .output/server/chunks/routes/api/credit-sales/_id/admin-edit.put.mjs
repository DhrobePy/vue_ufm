import { q as defineEventHandler, R as getRouterParam, ar as readBody, X as getUserSession, b as ADMIN_ROLES, m as createError, z as getDb, g as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
