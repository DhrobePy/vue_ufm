import { p as defineEventHandler, O as getRouterParam, am as readBody, V as getUserSession, b as ADMIN_ROLES, l as createError, y as getDb, f as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
