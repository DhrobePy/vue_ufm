import { n as defineEventHandler, K as getRouterParam, ab as readBody, N as getUserSession, a as ADMIN_ROLES, j as createError, v as getDb, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
