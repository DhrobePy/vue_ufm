import { o as defineEventHandler, M as getRouterParam, af as readBody, Q as getUserSession, a as ADMIN_ROLES, k as createError, x as getDb, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
