import { o as defineEventHandler, L as getRouterParam, k as createError, ae as readBody, O as getUserSession, F as getRequestHeader, aA as userCanAction, A as ACCOUNTS_ROLES, w as getDb, i as checkTransactionLimit, ad as queuePendingRequest, at as sendTelegram, C as getOrderGateState, e as auditLog, g as bridgeCustomerPayment } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
...
const payment_post = defineEventHandler(async (event) => {
  ...
  const userRole = ((_b = session.user.role) != null ? _b : "").toLowerCase();
...
\u09F3${Number(amount).toLocaleString()} \xB7 Requested by ${userName} (over their \u09F3${limitCheck.cap.toLocaleString()} limit)`
    ...
    const newPaid = Number((_h = order.amount_paid) != null ? _h : 0) + pmtAmount;
    const newBalance = Math.max(0, Number((_i = order.balance_due) != null ? _i : 0) - pmtAmount);
    ...
    const seq = String(((_j = seq_row.n) != null ? _j : 0) + 1).padStart(4, "0");
    ...
    const prevBal = Number((_k = lastLedger == null ? void 0 : lastLedger.bal) != null ? _k : 0);
    ...
    try {
      ...
      if (mappedMethod === "Cash" && cash_account_id) {
        ...
        drAccountId = (_l = ca == null ? void 0 : ca.chart_of_account_id) != null ? _l : null;
        ...
        drAccountId = (_n = ba == null ? void 0 : ba.chart_of_account_id) != null ? _n : null;
      }
      ...
      const crAccountId = (_o = ar == null ? void 0 : ar.id) != null ? _o : null;
      if (drAccountId && crAccountId) {
        ...
        if (mappedMethod === "Cash" && cash_account_id) {
          ...
          const pcBal = Number((_p = pcAcc == null ? void 0 : pcAcc.current_balance) != null ? _p : 0);
          await conn.query(
            ...
            [
              Number(cash_account_id),
              (_q = pcAcc == null ? void 0 : pcAcc.branch_id) != null ? _q : null,
              pmtAmount,
              pcBal + pmtAmount,
              paymentId,
...
\u09F3${pmtAmount.toLocaleString()} via ${mappedMethod} \xB7 balance \u09F3${newBalance.toLocaleString()}` + (isNowComplete ? "\n\u2705 Order fully paid & completed" : "") + (autoReleased ? "\n\u{1F7E2} Dispatch clearance auto-released" : "")
    ...
    throw createError({
      statusCode: 500,
      statusMessage: (_s = (_r = e == null ? void 0 : e.sqlMessage) != null ? _r : e == null ? void 0 : e.message) != null ? _s : "Payment transaction failed"
    });
  } finally {
    conn.release();
  }
