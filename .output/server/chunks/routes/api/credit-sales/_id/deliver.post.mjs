import { o as defineEventHandler, L as getRouterParam, k as createError, ac as readBody, O as getUserSession, F as getRequestHeader, w as getDb, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
