import { q as defineEventHandler, R as getRouterParam, as as readBody, X as getUserSession, m as createError, a1 as isAdminRole, aQ as userCanAction, a0 as isAccountsRole, z as getDb, g as auditLog, H as getOrderGateState, aJ as sendTelegram, A as ACCOUNTS_ROLES } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
