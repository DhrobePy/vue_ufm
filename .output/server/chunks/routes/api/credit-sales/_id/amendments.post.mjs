import { n as defineEventHandler, K as getRouterParam, aa as readBody, N as getUserSession, j as createError, S as isAccountsRole, v as getDb, c as AMD_PRE_STATUSES, b as AMD_POST_STATUSES, L as getUserApprovalLimit, X as nextDocNumber, d as applyAmendment, e as auditLog, ai as sendTelegram } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
