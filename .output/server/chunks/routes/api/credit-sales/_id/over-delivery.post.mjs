import { n as defineEventHandler, H as getRouterParam, j as createError, a7 as readBody, K as getUserSession, u as getDb, U as nextDocNumber, e as auditLog, ad as sendTelegram } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
