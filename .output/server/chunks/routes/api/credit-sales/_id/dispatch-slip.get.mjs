import { o as defineEventHandler, L as getRouterParam, k as createError, O as getUserSession, w as getDb, x as getDeliveryQrSecret, r as deliveryQrSignature } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
