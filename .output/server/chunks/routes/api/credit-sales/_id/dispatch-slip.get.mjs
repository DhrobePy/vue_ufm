import { n as defineEventHandler, K as getRouterParam, j as createError, N as getUserSession, v as getDb, w as getDeliveryQrSecret, q as deliveryQrSignature } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
