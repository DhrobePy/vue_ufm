import { q as defineEventHandler, X as getUserSession, b as ADMIN_ROLES, m as createError, aq as readBody, z as getDb, a as ACTION_LIMIT_KEYS, g as auditLog } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
