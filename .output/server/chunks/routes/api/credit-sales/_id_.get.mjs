import { p as defineEventHandler, O as getRouterParam, l as createError, ak as queryOne, aj as query, z as getDeliveryQrSecret, y as getDb, s as deliveryQrSignature } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
