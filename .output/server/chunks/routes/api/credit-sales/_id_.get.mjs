import { o as defineEventHandler, L as getRouterParam, k as createError, aa as queryOne, a9 as query, x as getDeliveryQrSecret, w as getDb, r as deliveryQrSignature } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
