import { q as defineEventHandler, R as getRouterParam, m as createError, ao as queryOne, an as query, B as getDeliveryQrSecret, z as getDb, t as deliveryQrSignature } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
