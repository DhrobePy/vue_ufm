import { q as defineEventHandler, R as getRouterParam, m as createError, ap as queryOne, ao as query, B as getDeliveryQrSecret, z as getDb, t as deliveryQrSignature } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
