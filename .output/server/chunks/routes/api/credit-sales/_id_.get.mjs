import { o as defineEventHandler, M as getRouterParam, k as createError, ad as queryOne, ac as query, y as getDeliveryQrSecret, x as getDb, r as deliveryQrSignature } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
