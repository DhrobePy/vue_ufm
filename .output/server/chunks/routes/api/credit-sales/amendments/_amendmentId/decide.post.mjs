import { m as defineEventHandler, H as getRouterParam, a4 as readBody, K as getUserSession, i as createError, u as getDb, I as getUserApprovalLimit, d as applyAmendment, e as auditLog, aa as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
