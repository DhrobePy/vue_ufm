import { q as defineEventHandler, R as getRouterParam, X as getUserSession, K as getRequestHeader, m as createError, z as getDb, g as auditLog, ay as recycleBegin, ax as recycleArchiveDelete, az as recycleFinalize } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
