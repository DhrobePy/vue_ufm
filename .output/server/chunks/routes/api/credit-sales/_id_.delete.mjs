import { n as defineEventHandler, I as getRouterParam, L as getUserSession, B as getRequestHeader, j as createError, u as getDb, e as auditLog } from '../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
