import { n as defineEventHandler, H as getRouterParam, K as getUserSession, z as getRequestHeader, j as createError, u as getDb, e as auditLog } from '../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
