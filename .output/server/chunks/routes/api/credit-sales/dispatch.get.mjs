import { o as defineEventHandler, O as getUserSession, w as getDb, N as getUserBranchScope, a9 as query, aa as queryOne, C as getOrderGateState } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
