import { n as defineEventHandler, L as getUserSession, u as getDb, K as getUserBranchScope, a6 as query, a7 as queryOne, y as getOrderGateState } from '../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
