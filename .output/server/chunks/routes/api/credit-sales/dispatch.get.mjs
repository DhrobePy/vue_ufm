import { p as defineEventHandler, V as getUserSession, y as getDb, U as getUserBranchScope, aj as query, ak as queryOne, G as getOrderGateState } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
