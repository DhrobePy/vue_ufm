import { n as defineEventHandler, N as getUserSession, v as getDb, M as getUserBranchScope, a7 as query, a8 as queryOne, B as getOrderGateState } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
