import { q as defineEventHandler, X as getUserSession, z as getDb, W as getUserBranchScope, ao as query, ap as queryOne, H as getOrderGateState } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
