import { n as defineEventHandler, I as getRouterParam, L as getUserSession, j as createError, Q as isAccountsRole, u as getDb, e as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
