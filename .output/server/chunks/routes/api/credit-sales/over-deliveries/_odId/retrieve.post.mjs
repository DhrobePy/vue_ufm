import { n as defineEventHandler, K as getRouterParam, N as getUserSession, j as createError, T as isAccountsRole, v as getDb, e as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
