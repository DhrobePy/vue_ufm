import { p as defineEventHandler, O as getRouterParam, V as getUserSession, l as createError, Z as isAccountsRole, y as getDb, f as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
