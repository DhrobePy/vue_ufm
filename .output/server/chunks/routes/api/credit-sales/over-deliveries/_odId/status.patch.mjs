import { o as defineEventHandler, M as getRouterParam, k as createError, Q as getUserSession, a as ADMIN_ROLES, af as readBody, x as getDb, B as getGLAccountId, aa as postJournalEntry, a8 as postCustomerLedger, e as auditLog, au as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
