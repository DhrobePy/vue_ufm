import { q as defineEventHandler, R as getRouterParam, m as createError, X as getUserSession, b as ADMIN_ROLES, as as readBody, z as getDb, E as getGLAccountId, al as postJournalEntry, ai as postCustomerLedger, g as auditLog, aJ as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
