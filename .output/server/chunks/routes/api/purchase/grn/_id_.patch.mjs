import { o as defineEventHandler, L as getRouterParam, k as createError, ac as readBody, O as getUserSession, w as getDb, af as recalcPO, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
