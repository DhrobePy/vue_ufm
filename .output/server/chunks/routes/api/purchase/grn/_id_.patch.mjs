import { h as defineEventHandler, v as getRouterParam, e as createError, K as readBody, w as getUserSession, n as getDb, N as recalcPO, a as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
