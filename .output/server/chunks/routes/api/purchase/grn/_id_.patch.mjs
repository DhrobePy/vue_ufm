import { o as defineEventHandler, M as getRouterParam, k as createError, af as readBody, Q as getUserSession, x as getDb, ai as recalcPO, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
