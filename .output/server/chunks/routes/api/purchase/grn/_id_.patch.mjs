import { n as defineEventHandler, K as getRouterParam, j as createError, ab as readBody, N as getUserSession, v as getDb, ae as recalcPO, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
