import { h as defineEventHandler, w as getRouterParam, e as createError, M as readBody, x as getUserSession, n as getDb, P as recalcPO, a as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
