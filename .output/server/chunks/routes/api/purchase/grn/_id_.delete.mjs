import { j as defineEventHandler, C as getRouterParam, f as createError, F as getUserSession, _ as readBody, q as getDb, a2 as recalcPO, b as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
