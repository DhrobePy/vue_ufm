import { n as defineEventHandler, K as getRouterParam, j as createError, N as getUserSession, aa as readBody, v as getDb, ad as recalcPO, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
