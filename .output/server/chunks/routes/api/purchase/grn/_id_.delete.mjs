import { q as defineEventHandler, R as getRouterParam, m as createError, X as getUserSession, ar as readBody, z as getDb, au as recalcPO, g as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
