import { n as defineEventHandler, H as getRouterParam, j as createError, K as getUserSession, a7 as readBody, u as getDb, aa as recalcPO, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
