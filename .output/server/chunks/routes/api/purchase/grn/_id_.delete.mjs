import { h as defineEventHandler, v as getRouterParam, e as createError, w as getUserSession, K as readBody, n as getDb, N as recalcPO, a as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
