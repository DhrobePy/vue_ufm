import { m as defineEventHandler, H as getRouterParam, i as createError, K as getUserSession, a4 as readBody, u as getDb, a7 as recalcPO, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
