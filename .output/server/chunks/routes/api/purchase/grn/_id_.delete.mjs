import { q as defineEventHandler, R as getRouterParam, m as createError, X as getUserSession, aq as readBody, z as getDb, at as recalcPO, g as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
