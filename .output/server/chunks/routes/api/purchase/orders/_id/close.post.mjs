import { n as defineEventHandler, H as getRouterParam, j as createError, a7 as readBody, K as getUserSession, u as getDb, e as auditLog, aa as recalcPO } from '../../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
