import { o as defineEventHandler, M as getRouterParam, k as createError, af as readBody, Q as getUserSession, x as getDb, e as auditLog, ad as queryOne } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
