import { n as defineEventHandler, K as getRouterParam, j as createError, ab as readBody, N as getUserSession, v as getDb, e as auditLog, a9 as queryOne } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
