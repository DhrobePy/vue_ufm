import { j as defineEventHandler, C as getRouterParam, f as createError, _ as readBody, F as getUserSession, q as getDb, b as auditLog, Z as queryOne } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
