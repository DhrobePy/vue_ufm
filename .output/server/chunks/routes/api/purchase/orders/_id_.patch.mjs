import { o as defineEventHandler, L as getRouterParam, k as createError, ae as readBody, O as getUserSession, w as getDb, e as auditLog, ac as queryOne } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
