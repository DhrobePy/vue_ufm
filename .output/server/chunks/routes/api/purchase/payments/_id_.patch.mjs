import { n as defineEventHandler, H as getRouterParam, j as createError, a7 as readBody, K as getUserSession, u as getDb, aa as recalcPO, e as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
