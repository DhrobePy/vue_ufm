import { q as defineEventHandler, R as getRouterParam, m as createError, X as getUserSession, z as getDb, ay as recycleBegin, ax as recycleArchiveDelete, az as recycleFinalize, au as recalcPO, g as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
