import { q as defineEventHandler, R as getRouterParam, m as createError, X as getUserSession, z as getDb, ax as recycleBegin, aw as recycleArchiveDelete, ay as recycleFinalize, au as recalcPO, g as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
