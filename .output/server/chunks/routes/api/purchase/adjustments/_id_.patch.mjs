import { h as defineEventHandler, v as getRouterParam, e as createError, K as readBody, w as getUserSession, J as queryOne, n as getDb, a as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
