import { q as defineEventHandler, R as getRouterParam, m as createError, ar as readBody, X as getUserSession, ap as queryOne, z as getDb, g as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
