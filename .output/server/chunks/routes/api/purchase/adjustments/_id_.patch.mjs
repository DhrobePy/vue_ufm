import { j as defineEventHandler, C as getRouterParam, f as createError, _ as readBody, F as getUserSession, Z as queryOne, q as getDb, b as auditLog } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
