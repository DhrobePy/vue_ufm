import { p as defineEventHandler, V as getUserSession, l as createError, aJ as userCanAction, A as ACCOUNTS_ROLES, S as SALES_ROLES, am as readBody, y as getDb } from '../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
