import { q as defineEventHandler, X as getUserSession, m as createError, aO as userCanAction, A as ACCOUNTS_ROLES, S as SALES_ROLES, ar as readBody, z as getDb, ah as postCustomerLedger, g as auditLog } from '../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
