import { o as defineEventHandler, Q as getUserSession, k as createError, aB as userCanAction, A as ACCOUNTS_ROLES, S as SALES_ROLES, af as readBody, x as getDb } from '../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
