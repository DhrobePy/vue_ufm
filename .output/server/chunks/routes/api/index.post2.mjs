import { o as defineEventHandler, O as getUserSession, k as createError, ax as userCanAction, A as ACCOUNTS_ROLES, S as SALES_ROLES, ac as readBody, w as getDb } from '../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
