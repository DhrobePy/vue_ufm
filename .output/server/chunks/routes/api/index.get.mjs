import { o as defineEventHandler, E as getQuery, O as getUserSession, w as getDb, N as getUserBranchScope, ab as query, C as getOrderGateState, a2 as paginate } from '../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
