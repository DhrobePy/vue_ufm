import { n as defineEventHandler, H as getRouterParam, a7 as readBody, K as getUserSession, j as createError, u as getDb, e as auditLog, W as notify, X as notifyAdmins } from '../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
