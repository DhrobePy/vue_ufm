import { q as defineEventHandler, R as getRouterParam, ar as readBody, X as getUserSession, m as createError, z as getDb, g as auditLog, a7 as notify, a8 as notifyAdmins } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
