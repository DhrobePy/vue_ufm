import { p as defineEventHandler, O as getRouterParam, am as readBody, V as getUserSession, l as createError, y as getDb, f as auditLog, a5 as notify, a6 as notifyAdmins } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
