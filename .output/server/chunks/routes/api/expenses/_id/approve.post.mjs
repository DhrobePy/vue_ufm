import { o as defineEventHandler, L as getRouterParam, ac as readBody, O as getUserSession, k as createError, w as getDb, e as auditLog, a0 as notify, a1 as notifyAdmins } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
