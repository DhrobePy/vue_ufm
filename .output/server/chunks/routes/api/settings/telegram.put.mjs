import { o as defineEventHandler, O as getUserSession, k as createError, ae as readBody, at as sendTelegram, ab as query, ap as resetTelegramCache } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
