import { n as defineEventHandler, N as getUserSession, j as createError, ab as readBody, ap as sendTelegram, a8 as query, am as resetTelegramCache } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
