import { q as defineEventHandler, X as getUserSession, m as createError, as as readBody, T as TELEGRAM_CATEGORIES, aJ as sendTelegram, ap as query, aE as resetTelegramCache } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
