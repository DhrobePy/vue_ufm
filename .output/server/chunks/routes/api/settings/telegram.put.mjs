import { n as defineEventHandler, N as getUserSession, j as createError, ab as readBody, ao as sendTelegram, a8 as query, al as resetTelegramCache } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
