import { o as defineEventHandler, O as getUserSession, k as createError, ac as readBody, aq as sendTelegram, a9 as query, an as resetTelegramCache } from '../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
