import { n as defineEventHandler, L as getUserSession, j as createError, a9 as readBody, ag as sendTelegram, a6 as query, ad as resetTelegramCache } from '../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
