import { m as defineEventHandler, K as getUserSession, i as createError, a4 as readBody, aa as sendTelegram, a2 as query, a8 as resetTelegramCache } from '../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
