import { n as defineEventHandler, K as getUserSession, j as createError, a7 as readBody, ad as sendTelegram, a4 as query, ab as resetTelegramCache } from '../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
