import { q as defineEventHandler, X as getUserSession, K as getRequestHeader, m as createError, R as getRouterParam, ar as readBody, z as getDb, g as auditLog, _ as invalidatePermCache } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
