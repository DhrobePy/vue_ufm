import { n as defineEventHandler, K as getUserSession, z as getRequestHeader, j as createError, H as getRouterParam, a7 as readBody, u as getDb, e as auditLog, N as invalidatePermCache } from '../../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
