import { m as defineEventHandler, K as getUserSession, z as getRequestHeader, i as createError, H as getRouterParam, a4 as readBody, u as getDb, e as auditLog, N as invalidatePermCache } from '../../../../../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:crypto';
import 'node:events';
