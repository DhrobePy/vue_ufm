import { o as defineEventHandler, O as getUserSession, F as getRequestHeader, k as createError, L as getRouterParam, ae as readBody, w as getDb, e as auditLog, T as invalidatePermCache } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
