import { o as defineEventHandler, Q as getUserSession, G as getRequestHeader, k as createError, M as getRouterParam, af as readBody, x as getDb, e as auditLog, U as invalidatePermCache } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
