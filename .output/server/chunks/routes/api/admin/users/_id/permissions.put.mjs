import { p as defineEventHandler, V as getUserSession, I as getRequestHeader, l as createError, O as getRouterParam, am as readBody, y as getDb, f as auditLog, Y as invalidatePermCache } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
