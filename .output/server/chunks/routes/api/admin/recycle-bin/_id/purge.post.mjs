import { o as defineEventHandler, Q as getUserSession, k as createError, M as getRouterParam, x as getDb, an as recyclePurge, e as auditLog } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
