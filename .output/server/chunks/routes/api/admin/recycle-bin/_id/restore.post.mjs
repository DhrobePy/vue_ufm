import { o as defineEventHandler, O as getUserSession, k as createError, L as getRouterParam, w as getDb, al as recycleRestore, e as auditLog, aq as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
