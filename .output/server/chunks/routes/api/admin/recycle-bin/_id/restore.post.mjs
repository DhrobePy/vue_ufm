import { p as defineEventHandler, V as getUserSession, l as createError, O as getRouterParam, y as getDb, av as recycleRestore, f as auditLog, aC as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
