import { o as defineEventHandler, Q as getUserSession, k as createError, M as getRouterParam, x as getDb, ao as recycleRestore, e as auditLog, au as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
