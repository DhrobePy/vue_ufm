import { n as defineEventHandler, N as getUserSession, j as createError, K as getRouterParam, v as getDb, ak as recycleRestore, e as auditLog, ao as sendTelegram } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'node:http';
import 'node:https';
import 'node:events';
